...
- [\#10992](https://gitlab.staging.haskell.org/ghc/ghc/issues/10992): `Data.List.sum` is much slower than the naive recursive definition for it.  Does not happen in 7.8.
- [\#6166](https://gitlab.staging.haskell.org/ghc/ghc/issues/6166): An alleged runtime performance regression in `mwc-random`.

- [\#14980](https://gitlab.staging.haskell.org/ghc/ghc/issues/14980) (regressed in 8.4): Runtime performance regression with binary operations on vectors 
...
<table><tr><th>[\#16064](https://gitlab.staging.haskell.org/ghc/ghc/issues/16064)</th>
...
<tr><th>[\#14519](https://gitlab.staging.haskell.org/ghc/ghc/issues/14519)</th>
...
<tr><th>[\#12781](https://gitlab.staging.haskell.org/ghc/ghc/issues/12781)</th>
...
<tr><th>[\#9801](https://gitlab.staging.haskell.org/ghc/ghc/issues/9801)</th>
...
<tr><th>[\#9214](https://gitlab.staging.haskell.org/ghc/ghc/issues/9214)</th>
...
<tr><th>[\#4262](https://gitlab.staging.haskell.org/ghc/ghc/issues/4262)</th>
...
<tr><th>[\#3737](https://gitlab.staging.haskell.org/ghc/ghc/issues/3737)</th>
<td>inlining happens on foldl1 and does not happen on direct application of combinator</td></tr>
<tr><th>[\#3736](https://gitlab.staging.haskell.org/ghc/ghc/issues/3736)</th>
<td>GHC specialising instead of inlining</td></tr>
<tr><th>[\#3735](https://gitlab.staging.haskell.org/ghc/ghc/issues/3735)</th>
<td>GHC specialising instead of inlining</td></tr>
<tr><th>[\#3717](https://gitlab.staging.haskell.org/ghc/ghc/issues/3717)</th>
<td>Superfluous seq no eliminated</td></tr>
<tr><th>[\#3709](https://gitlab.staging.haskell.org/ghc/ghc/issues/3709)</th>
<td>Data.Either.partitionEithers is not lazy enough</td></tr>
<tr><th>[\#3698](https://gitlab.staging.haskell.org/ghc/ghc/issues/3698)</th>
<td>Bad code generated for zip/filter/filter loop</td></tr>
<tr><th>[\#3697](https://gitlab.staging.haskell.org/ghc/ghc/issues/3697)</th>
<td>Method selectors aren't floated out of loops</td></tr>
<tr><th>[\#3655](https://gitlab.staging.haskell.org/ghc/ghc/issues/3655)</th>
<td>Performance regression relative to 6.10</td></tr>
<tr><th>[\#3627](https://gitlab.staging.haskell.org/ghc/ghc/issues/3627)</th>
<td>Profiling loses eta-expansion opportunities unnecessarily</td></tr>
<tr><th>[\#3586](https://gitlab.staging.haskell.org/ghc/ghc/issues/3586)</th>
<td>Initialisation of unboxed arrays is too slow</td></tr>
<tr><th>[\#3526](https://gitlab.staging.haskell.org/ghc/ghc/issues/3526)</th>
<td>Inliner behaviour with instances is confusing</td></tr>
<tr><th>[\#3518](https://gitlab.staging.haskell.org/ghc/ghc/issues/3518)</th>
<td>GHC GC rises greatly on -N8 compared to -N7</td></tr>
<tr><th>[\#3501](https://gitlab.staging.haskell.org/ghc/ghc/issues/3501)</th>
<td>Error thunks not being exposed with "B" strictness</td></tr>
<tr><th>[\#3437](https://gitlab.staging.haskell.org/ghc/ghc/issues/3437)</th>
<td>Optimizer creates space leak on simple code</td></tr>
<tr><th>[\#3349](https://gitlab.staging.haskell.org/ghc/ghc/issues/3349)</th>
<td>poor responsiveness of ghci</td></tr>
<tr><th>[\#3331](https://gitlab.staging.haskell.org/ghc/ghc/issues/3331)</th>
...
<tr><th>[\#3264](https://gitlab.staging.haskell.org/ghc/ghc/issues/3264)</th>
<td>Real World Haskell book example issue</td></tr>
<tr><th>[\#3245](https://gitlab.staging.haskell.org/ghc/ghc/issues/3245)</th>
<td>Quadratic slowdown in Data.Typeable</td></tr>
<tr><th>[\#3181](https://gitlab.staging.haskell.org/ghc/ghc/issues/3181)</th>
<td>Regression in unboxing</td></tr>
<tr><th>[\#3123](https://gitlab.staging.haskell.org/ghc/ghc/issues/3123)</th>
<td>make INLINE work for recursive definitions (generalized loop peeling/loop unrolling)</td></tr>
<tr><th>[\#3116](https://gitlab.staging.haskell.org/ghc/ghc/issues/3116)</th>
<td>missed opportunity for call-pattern specialisation</td></tr>
<tr><th>[\#3076](https://gitlab.staging.haskell.org/ghc/ghc/issues/3076)</th>
<td>Make genericLength tail-recursive so it doesn't overflow stack</td></tr>
<tr><th>[\#3065](https://gitlab.staging.haskell.org/ghc/ghc/issues/3065)</th>
...
<tr><th>[\#2915](https://gitlab.staging.haskell.org/ghc/ghc/issues/2915)</th>
<td>Arity is smaller than need be</td></tr>
<tr><th>[\#2902](https://gitlab.staging.haskell.org/ghc/ghc/issues/2902)</th>
<td>Example where ghc 6.10.1 fails to optimize recursive instance function calls</td></tr>
<tr><th>[\#2884](https://gitlab.staging.haskell.org/ghc/ghc/issues/2884)</th>
<td>Compiled code performance worsens when module names are long enough</td></tr>
<tr><th>[\#2840](https://gitlab.staging.haskell.org/ghc/ghc/issues/2840)</th>
<td>Top level string literals</td></tr>
<tr><th>[\#2831](https://gitlab.staging.haskell.org/ghc/ghc/issues/2831)</th>
<td>Floated error expressions get poor strictness, leaving bad arity</td></tr>
<tr><th>[\#2823](https://gitlab.staging.haskell.org/ghc/ghc/issues/2823)</th>
<td>Another arity expansion bug</td></tr>
<tr><th>[\#2822](https://gitlab.staging.haskell.org/ghc/ghc/issues/2822)</th>
<td>Arity expansion not working right</td></tr>
<tr><th>[\#2797](https://gitlab.staging.haskell.org/ghc/ghc/issues/2797)</th>
<td>ghci stack overflows when ghc does not</td></tr>
<tr><th>[\#2785](https://gitlab.staging.haskell.org/ghc/ghc/issues/2785)</th>
<td>Memory leakage with socket benchmark program</td></tr>
<tr><th>[\#2727](https://gitlab.staging.haskell.org/ghc/ghc/issues/2727)</th>
<td>DiffArray performance unusable for advertized purpose</td></tr>
<tr><th>[\#2720](https://gitlab.staging.haskell.org/ghc/ghc/issues/2720)</th>
<td>eyeball/inline1 still isn't optimised with -fno-method-sharing</td></tr>
<tr><th>[\#2712](https://gitlab.staging.haskell.org/ghc/ghc/issues/2712)</th>
<td>Parallel GC scheduling problems</td></tr>
<tr><th>[\#2581](https://gitlab.staging.haskell.org/ghc/ghc/issues/2581)</th>
<td>Record selectors not being inlined</td></tr>
<tr><th>[\#2463](https://gitlab.staging.haskell.org/ghc/ghc/issues/2463)</th>
<td>unsafePerformIO in unused record field affects optimisations</td></tr>
<tr><th>[\#2462](https://gitlab.staging.haskell.org/ghc/ghc/issues/2462)</th>
<td>Data.List.sum is slower than 6.8.3</td></tr>
<tr><th>[\#2450](https://gitlab.staging.haskell.org/ghc/ghc/issues/2450)</th>
<td>Data.Complex.magnitude squares using \^(2 :: Int), which is slow</td></tr>
<tr><th>[\#2440](https://gitlab.staging.haskell.org/ghc/ghc/issues/2440)</th>
<td>Bad code with type families</td></tr>
<tr><th>[\#2396](https://gitlab.staging.haskell.org/ghc/ghc/issues/2396)</th>
<td>Default class method not inlined</td></tr>
<tr><th>[\#2329](https://gitlab.staging.haskell.org/ghc/ghc/issues/2329)</th>
<td>Control.Parallel.Strategies: definitions of rnf for most collections are poor</td></tr>
<tr><th>[\#2325](https://gitlab.staging.haskell.org/ghc/ghc/issues/2325)</th>
<td>Compile-time computations</td></tr>
<tr><th>[\#2280](https://gitlab.staging.haskell.org/ghc/ghc/issues/2280)</th>
<td>randomR too slow</td></tr>
<tr><th>[\#2253](https://gitlab.staging.haskell.org/ghc/ghc/issues/2253)</th>
<td>Native code generator could do better</td></tr>
<tr><th>[\#2236](https://gitlab.staging.haskell.org/ghc/ghc/issues/2236)</th>
<td>Deep stacks make execution time go through the roof</td></tr>
<tr><th>[\#2185](https://gitlab.staging.haskell.org/ghc/ghc/issues/2185)</th>
<td>Memory leak with parMap</td></tr>
<tr><th>[\#2163](https://gitlab.staging.haskell.org/ghc/ghc/issues/2163)</th>
<td>GHC makes thunks for Integers we are strict in</td></tr>
<tr><th>[\#2105](https://gitlab.staging.haskell.org/ghc/ghc/issues/2105)</th>
<td>garbage collection confusing in ghci for foreign objects</td></tr>
<tr><th>[\#2092](https://gitlab.staging.haskell.org/ghc/ghc/issues/2092)</th>
<td>Quadratic amount of code generated</td></tr>
<tr><th>[\#2078](https://gitlab.staging.haskell.org/ghc/ghc/issues/2078)</th>
<td>INLINE and strictness</td></tr>
<tr><th>[\#1890](https://gitlab.staging.haskell.org/ghc/ghc/issues/1890)</th>
<td>Regression in mandelbrot benchmark due to inlining</td></tr>
<tr><th>[\#1889](https://gitlab.staging.haskell.org/ghc/ghc/issues/1889)</th>
<td>Regression in concurrency performance from ghc 6.6 to 6.8</td></tr>
<tr><th>[\#1818](https://gitlab.staging.haskell.org/ghc/ghc/issues/1818)</th>
<td>Code size increase vs. 6.6.1</td></tr>
<tr><th>[\#1752](https://gitlab.staging.haskell.org/ghc/ghc/issues/1752)</th>
<td>CSE can create space leaks by increasing sharing</td></tr>
<tr><th>[\#1607](https://gitlab.staging.haskell.org/ghc/ghc/issues/1607)</th>
<td>seq can make code slower</td></tr>
<tr><th>[\#1434](https://gitlab.staging.haskell.org/ghc/ghc/issues/1434)</th>
<td>Missing RULEs for truncate</td></tr>
<tr><th>[\#1117](https://gitlab.staging.haskell.org/ghc/ghc/issues/1117)</th>
<td>\[2,4..10\] is not a good list producer</td></tr>
<tr><th>[\#955](https://gitlab.staging.haskell.org/ghc/ghc/issues/955)</th>
<td>more object-code blow-up in ghc-6.8.3 vs. ghc-6.4.2 (both with optimization)</td></tr>
<tr><th>[\#876](https://gitlab.staging.haskell.org/ghc/ghc/issues/876)</th>
<td>Length is not a good consumer</td></tr>
<tr><th>[\#783](https://gitlab.staging.haskell.org/ghc/ghc/issues/783)</th>
<td>SRTs bigger than they should be?</td></tr>
<tr><th>[\#650](https://gitlab.staging.haskell.org/ghc/ghc/issues/650)</th>
<td>Improve interaction between mutable arrays and GC</td></tr>
<tr><th>[\#635](https://gitlab.staging.haskell.org/ghc/ghc/issues/635)</th>
<td>Replace use of select() in the I/O manager with epoll/kqueue/etc.</td></tr>
<tr><th>[\#594](https://gitlab.staging.haskell.org/ghc/ghc/issues/594)</th>
<td>Support use of SSE2 in the x86 native code genreator</td></tr>
<tr><th>[\#427](https://gitlab.staging.haskell.org/ghc/ghc/issues/427)</th>
...
- **fannkuch-redux**: increased by factor of 10,000?!?!
  ...
  - Filed [\#10717](https://gitlab.staging.haskell.org/ghc/ghc/issues/10717) to track this.
