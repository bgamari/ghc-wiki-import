...
Most of the work on this was already done by Jared Weekly for the 2017 Haskell Summer of Code ([
...
- The change to comparing with the previous commit means that performance results may drift in one direction without tests ever failing. As we are changing from using expected values to using  Local testing (no git note for previous commit)
- Drift (better option that compare with last)

## See also


- stemming from issue [\#12758](https://gitlab.staging.haskell.org/ghc/ghc/issues/12758).
