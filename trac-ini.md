...
<tr><th> `authz_file`      </th>
<th> Path to Subversion [
authorization (authz) file](http://svnbook.red-bean.com/en/1.1/ch06s04.html#svn-ch-6-sect-4.4.2). 
</th></tr>
...
<tr><th> `log_file`  </th>
<th> If *log\_type* is *file*, this should be a path to the log-file 
</th></tr>
<tr><th> `log_level` </th>
...
>
>
> *Note that prior to Trac [r2335](/trac/ghc/changeset/2335/ghc) (that applies to 0.9b1 and 0.9b2), you would use a `[disabled_components]` section instead. See a [
> previous version](http://projects.edgewall.com/trac/wiki/TracIni?version=42) of this page for the details.*
>
>
