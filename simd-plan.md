...
The compiler/vectorise code contains the implementation details for the [
VECTORISE pragma](http://hackage.haskell.org/trac/ghc/wiki/DataParallel/VectPragma).
