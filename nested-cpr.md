...
- [\#1600](https://gitlab.staging.haskell.org/ghc/ghc/issues/1600), \*2289, [\#2387](https://gitlab.staging.haskell.org/ghc/ghc/issues/2387) (see [below](nested-cpr#motivating-examples) for an analysis)
