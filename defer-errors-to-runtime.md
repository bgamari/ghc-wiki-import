...
This page describes the `-fdefer-type-errors` flag that was added in GHC 7.6.1. Ticket [\#5624](https://gitlab.staging.haskell.org/ghc/ghc/issues/5624) tracks this feature request.
...
<table><tr><th>[\#11197](https://gitlab.staging.haskell.org/ghc/ghc/issues/11197)</th>
...
<table><tr><th>[\#14325](https://gitlab.staging.haskell.org/ghc/ghc/issues/14325)</th>
