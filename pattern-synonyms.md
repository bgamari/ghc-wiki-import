...
- [\#8968](https://gitlab.staging.haskell.org/ghc/ghc/issues/8968) (GADTs)
- [\#9417](https://gitlab.staging.haskell.org/ghc/ghc/issues/9417) (Haddock)
- [\#9514](https://gitlab.staging.haskell.org/ghc/ghc/issues/9514) (Haddock again)
- [\#8584](https://gitlab.staging.haskell.org/ghc/ghc/issues/8584) (pattern type signatures)


Relevant open tickets:


- [\#8581](https://gitlab.staging.haskell.org/ghc/ghc/issues/8581) (explicitly bidirectional)
- [\#8582](https://gitlab.staging.haskell.org/ghc/ghc/issues/8582) (Record patterns)
- [\#8583](https://gitlab.staging.haskell.org/ghc/ghc/issues/8583) (Associated patterns)
- [\#8761](https://gitlab.staging.haskell.org/ghc/ghc/issues/8761) (template haskell support)
- [\#8779](https://gitlab.staging.haskell.org/ghc/ghc/issues/8779) (exhaustiveness checks)
- [\#10783](https://gitlab.staging.haskell.org/ghc/ghc/issues/10783) (partial type signatures in pattern synonym signatures)
- [\#10653](https://gitlab.staging.haskell.org/ghc/ghc/issues/10653) (Associated pattern synonyms with types)
- [\#10932](https://gitlab.staging.haskell.org/ghc/ghc/issues/10932) (View patterns with arguments)
