...
- New `base` classes library: The `Bifoldable` and `Bitraversable` typeclasses are now included in the `base` library, along with built-in GHC support for instance derivation.
