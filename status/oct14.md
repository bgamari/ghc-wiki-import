...
- **Binary literals** ([\#9224](https://gitlab.staging.haskell.org/ghc/ghc/issues/9224)) - Herbert implemented the `-XBinaryLiterals` language extension which finally closes the syntax gap relative to other languages which allow to write base-2 literals such as `0b11001001`.
