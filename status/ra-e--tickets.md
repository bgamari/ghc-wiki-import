...
- [\#9838](https://gitlab.staging.haskell.org/ghc/ghc/issues/9838): Don't require `PatternSynonyms` and `ConstraintKinds` at use sites
...
- [\#9872](https://gitlab.staging.haskell.org/ghc/ghc/issues/9872): Type families are too slow
...
- [\#7947](https://gitlab.staging.haskell.org/ghc/ghc/issues/7947): Names generated when deriving `Data` should be more unique
