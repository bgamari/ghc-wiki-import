...
DPH remains under very active development. The [current state of play](data-parallel) is documented on the wiki.  We also wrote a substantial paper [
...
comparison between x86 and T2 on a memory-intensive benchmark (dot product)](http://justtesting.org/post/83014052/this-is-the-performance-of-a-dot-product-of-two) and [
a performance summary of the benchmarks on both machines.](http://justtesting.org/post/85103645/these-graphs-summarise-the-performance-of-data)
