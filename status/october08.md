 ...
 * The base library now uses extensible exceptions, as described in Simon Marlow's paper [http://www.haskell.org/~simonmar/papers/ext-exceptions.pdf An Extensible Dynamically-Typed Hierarchy of Exceptions] (Haskell workshop 2006).
