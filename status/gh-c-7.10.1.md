 ...
 * We haven't planned an RC yet, but hope one **might be out by Christmas**.
   ...
   - Phab:D396: DWARF debug information (dependent on Phab:D169)
   - Phab:D476: Deriving for arbitrary classes
...
[[TicketQuery(milestone=7.10.1,status!=closed,format=table,col=type|summary|priority|owner,group=status)]]
