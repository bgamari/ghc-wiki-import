...
- Austin Seipp needs to upload the primops compatibility package for 7.8. This is mostly a copy of `compiler/utils/ExtsCompat64.hs` into a Cabal package. See also [
...
- Austin also still has a lingering patch for [\#7602](https://gitlab.staging.haskell.org/ghc/ghc/issues/7602) to fix a large OS X performance regression, but it's still not merged. This is because the thread-local storage implementation changed in OS X Mavericks, requiring more investigation.
