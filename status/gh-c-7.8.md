...
- The Applicative-Monad warnings would preferably be integrated. See [\#8004](https://gitlab.staging.haskell.org/ghc/ghc/issues/8004). David Luposchainsky is driving this. (Current status: Warnings implemented, GHC compiles AMP-warning-free. What's left to do is getting the testsuite up to date with this.)
