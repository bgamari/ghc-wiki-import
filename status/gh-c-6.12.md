...
- **Haddock 2** (see also [\#1964](https://gitlab.staging.haskell.org/ghc/ghc/issues/1964) (GHC.Prim), [\#2335](https://gitlab.staging.haskell.org/ghc/ghc/issues/2335) (build problem)).  (Ian: a few days.)
...
- **Back-end revamp**, remove mangler (see also [\#1501](https://gitlab.staging.haskell.org/ghc/ghc/issues/1501)).  John Dias is in charge.  For 6.10 we will make sure that the whole existing path still exists, so we can choose at a late date whether to rely on the new path or not.
...
- shared libraries ([\#1876](https://gitlab.staging.haskell.org/ghc/ghc/issues/1876))
- Haddock 2 (see also [\#1964](https://gitlab.staging.haskell.org/ghc/ghc/issues/1964) (GHC.Prim), [\#2335](https://gitlab.staging.haskell.org/ghc/ghc/issues/2335) (build problem))
...
- more library reorg ([\#1338](https://gitlab.staging.haskell.org/ghc/ghc/issues/1338))
...
- `^C` should raise an exception by default (also SIGPIPE, see [\#1619](https://gitlab.staging.haskell.org/ghc/ghc/issues/1619), [\#2301](https://gitlab.staging.haskell.org/ghc/ghc/issues/2301))
