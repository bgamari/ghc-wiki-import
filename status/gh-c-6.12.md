...
- Back-end revamp, remove mangler (see also [\#1501](https://gitlab.staging.haskell.org/ghc/ghc/issues/1501))
...
- <sup>C should raise an exception by default (also SIGPIPE, see [\#1619](https://gitlab.staging.haskell.org/ghc/ghc/issues/1619), [\#2301](https://gitlab.staging.haskell.org/ghc/ghc/issues/2301))
  </sup>
