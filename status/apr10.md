...
- The [
  Threadscope](http://research.microsoft.com/threadscope) tool for visualising parallel execution was released.  The tool is ripe for improvement in many ways, if you're interested in helping let us know
...
- \[NoSlow\] The NoSlow array benchmark framework [
  NoSlow](http://hackage.haskell.org/package/NoSlow)
