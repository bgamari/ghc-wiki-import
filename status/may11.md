...
GHC is still busy as ever. The GHC 7.0 branch has come and gone, and now that the branch has been closed we have finally made the long-planned switch from darcs to git. Meanwhile, we are busily working towards the 7.2 branch, and hope to make the 7.2.1 release in June.
...
sleeves and help us with GHC.  Amongst those who have got involved recently are:
  (The cross-compilation crew springs to mind. And some OS X / FBSD / Solaris / etc activity recently)
...
Release status: 7.0 closed, 7.2 imminent, 7.4 coming soon
