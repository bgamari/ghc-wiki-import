 ...
 * Simon PJ and Dimitrios '''complete rewrite of the constraint solver in the type inference engine''': done? any correctness or performance regressions remaining?

 * David Terei LLVM; any news?
