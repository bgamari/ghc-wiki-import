 ...
 * '''Simon Marlow''' has implemented a chunked stack representation, which should improve the performance of programs that need large stacks.  See the [[http://hackage.haskell.org/trac/ghc/blog/stack-chunks blog post]].  This is already in the mainline and will be in the 7.2.1 release.
 ...
 * [!StackChunks] http://hackage.haskell.org/trac/ghc/blog/stack-chunks
```
