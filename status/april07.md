...
wonderful paper **"xxx"** on implementing a network protocol stack in
...
- Pepe Iborra, Bernie Pope, and Simon Marlow have leveraged the same
  ...
  a breakpoint debugger in GHCi.  Unlike HAT, whioh transforms the whole
