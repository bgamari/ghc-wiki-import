...
language (without typeclasses) [[http://goto.ucsd.edu/~rjhala/liquid]]. Currently, we are working 
on ways of handling at the basic typeclasses (Ord, Num etc.), and building a web-interface.
