...
The first version of Cloud Haskell has been released, aiming to bring Erlang-style distributed actors to Haskell [
...
- Extending the code generator to exploit vector instructions (with Peter Braam, Paul Monday, Duncan Coutts) [
