...
fixing one of GHC's more embarassing bugs (Trac [\#1969](https://gitlab.staging.haskell.org/ghc/ghc/issues/1969) **Simon check**),
...
Most of the changes in this area in GHC 6.12.1 were described in our ICFP'09 paper \[!ICFP09b\][
Runtime Support for Multicore Haskell](http://www.haskell.org/~simonmar/bib/multicore-ghc-09_abstract.html).  The highlights:
