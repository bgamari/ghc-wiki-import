 ...
 * #2838: trouble with `CmmInt` masking; watch out for this
 ...
 * #1897: '''Ambiguity: don't infer a type that can't be checked if the type is given as a signature''' (this one is important)
