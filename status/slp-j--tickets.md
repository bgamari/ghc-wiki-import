...
- [\#3586](https://gitlab.staging.haskell.org/ghc/ghc/issues/3586): slow array code (ST monad)
...
- [\#2255](https://gitlab.staging.haskell.org/ghc/ghc/issues/2255), [\#3767](https://gitlab.staging.haskell.org/ghc/ghc/issues/3767), [\#2642](https://gitlab.staging.haskell.org/ghc/ghc/issues/2642): Improve **`SpecConstr`** for free variables, and for join points.
