...
- **[\#4232](https://gitlab.staging.haskell.org/ghc/ghc/issues/4232): main meta-ticket for the new type checker**
...
- [\#4338](https://gitlab.staging.haskell.org/ghc/ghc/issues/4338): superclass equalities
...
- [\#1823](https://gitlab.staging.haskell.org/ghc/ghc/issues/1823): refinement
- [\#3714](https://gitlab.staging.haskell.org/ghc/ghc/issues/3714): error message if associated family has excess parameters
- [\#3554](https://gitlab.staging.haskell.org/ghc/ghc/issues/3554): assertion failure
- [\#3330](https://gitlab.staging.haskell.org/ghc/ghc/issues/3330): type checker loops
- [\#3500](https://gitlab.staging.haskell.org/ghc/ghc/issues/3500): recursive dictionaries
- [\#3787](https://gitlab.staging.haskell.org/ghc/ghc/issues/3787): bad program produced
- [\#4226](https://gitlab.staging.haskell.org/ghc/ghc/issues/4226): strange implicit-parameter behaviour
- [\#4160](https://gitlab.staging.haskell.org/ghc/ghc/issues/4160): Type families crash in HEAD
- [\#4200](https://gitlab.staging.haskell.org/ghc/ghc/issues/4200): don't require `UndecidableInstances` for equality constraints
- [\#4178](https://gitlab.staging.haskell.org/ghc/ghc/issues/4178): unnecessary skolem escape check
- [\#4179](https://gitlab.staging.haskell.org/ghc/ghc/issues/4179): loop in type inference
...
- [\#2256](https://gitlab.staging.haskell.org/ghc/ghc/issues/2256): Incomplete inference when generalising
...
- [\#4254](https://gitlab.staging.haskell.org/ghc/ghc/issues/4254): fundeps
