...
- [\#2838](https://gitlab.staging.haskell.org/ghc/ghc/issues/2838): trouble with `CmmInt` masking; watch out for this
...
- [\#1897](https://gitlab.staging.haskell.org/ghc/ghc/issues/1897): don't infer a type that can't be checked if the type is given as a signature
