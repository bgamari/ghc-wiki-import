...
== Urgent or in-flight ==
 * #9497: typed holes: minor flag change
 * #9260: type lits (Iavor owns)
 * #7015: support for `static`
 * #9404: `tcInfer` infelicity (Richard owns)
 * #9400: `unpackCString#` rules (asked for volunteers)
 * #8634, #9267, #9227: relaxing functional dependency rules `-XDysFunctionalDependencies`
 * #9318: bad type error caused by wanted/wanted solving (talk to Dimitrios)
 * #8852, #8980, #8941 (possibly), #8960, #7898, #7068, #7944, #5550, #8836: `SpecConstr` blowup
 * #9123: higher order roles
 * #9200, #9151: kind inference for mutually recursive types (Richard owns)
 * #9352: allow `State#` in FFI types.
 * #9211, #9090: using equalities to let-bind type variables; level numbers on skolems
 * #9388: narrow the state hack
 * #9367: type-level "error" function
 ...
 * #8968, #9226: pattern synonyms and GADTs
 * #8581: bidirectional pattern synonyms (with different constraints)
 * #8582: pattern synonyms and record syntax
 ...
 * #2182, #8427: stop EPS cache poisoning
 ...
 * #9117: rules for solving `Coercible` constraints
 ...
 * #8984: better error message for `Coercible`

== Template Haskell ==
See also [wiki:TemplateHaskell]

 * #9262: allow free variables in `reifyInstances`
 * #9209: allow splicing declarations in `let`/`where`.  Currently we just get a crash.
...
== Optimisation ==
 * #9370: massive blow-up unless you switch off all optimisation
 ...
 * #8317, #8326, #9661: don't push heapchecks into case branches too aggressively.  This is closely related to work Jan Stolarek did on unboxed booleans.
 ...
 * #9328: negative zero and case expressions
 ...
 * #9497: typed holes: silencing them
 * #9404: tcInfer and `PolyTv`
 ...
 * #4347, #4295, #7264, #8808, #9420, #9730: impredicativity
 ...
 * #595, #5728, #3927, #5724, #5762, #4139, #6124, #7669, #322, #8016, #8494, #8853, #8970, #9113: '''pattern-match overlap checking''', including with GADTs
