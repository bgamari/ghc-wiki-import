...
- `TypeError`: [Custom type errors](proposal/custom-type-errors)
...
- [\#8585](https://gitlab.staging.haskell.org/ghc/ghc/issues/8585): loopification; see also [Commentary/Compiler/Loopification](commentary/compiler/loopification)
