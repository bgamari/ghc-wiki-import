...
- [\#10045](https://gitlab.staging.haskell.org/ghc/ghc/issues/10045): partial type sig bug (Thomas W is working on this)
...
- [\#10293](https://gitlab.staging.haskell.org/ghc/ghc/issues/10293): too much time in `CallArity` (Joachim) \* [\#10228](https://gitlab.staging.haskell.org/ghc/ghc/issues/10228): regression from 7.8.4 to 7.10.1
...
- [\#10318](https://gitlab.staging.haskell.org/ghc/ghc/issues/10318): recursive superclasses
...
- [\#7367](https://gitlab.staging.haskell.org/ghc/ghc/issues/7367): float-out causes extra allocation
