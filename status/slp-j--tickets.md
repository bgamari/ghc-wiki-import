...
- [\#12776](https://gitlab.staging.haskell.org/ghc/ghc/issues/12776): definitely a loop; has diagnosis
- [\#12781](https://gitlab.staging.haskell.org/ghc/ghc/issues/12781): join points
...
- [\#12170](https://gitlab.staging.haskell.org/ghc/ghc/issues/12170): add a flag to control how out-of-scope variables are deferred
...
- [\#9918](https://gitlab.staging.haskell.org/ghc/ghc/issues/9918): closed type families, apartness, and overlapping instances (inconsistency)
- [\#9118](https://gitlab.staging.haskell.org/ghc/ghc/issues/9118): Eta reduction for `Coercible` (not expressible in Core, yet)
- [\#6018](https://gitlab.staging.haskell.org/ghc/ghc/issues/6018), [\#10227](https://gitlab.staging.haskell.org/ghc/ghc/issues/10227), [\#10832](https://gitlab.staging.haskell.org/ghc/ghc/issues/10832), [\#4259](https://gitlab.staging.haskell.org/ghc/ghc/issues/4259): injective type families
...
- [\#11514](https://gitlab.staging.haskell.org/ghc/ghc/issues/11514): Impredicativity sneaking in (should be easy)
...
- [\#11375](https://gitlab.staging.haskell.org/ghc/ghc/issues/11375): type synonyms slower than type families
...
- [\#9979](https://gitlab.staging.haskell.org/ghc/ghc/issues/9979), [\#8814](https://gitlab.staging.haskell.org/ghc/ghc/issues/8814), [\#8835](https://gitlab.staging.haskell.org/ghc/ghc/issues/8835): attoparsec regressed 7.8.4 to HEAD
...
- [\#10858](https://gitlab.staging.haskell.org/ghc/ghc/issues/10858): `Ord` instances
- [\#1544](https://gitlab.staging.haskell.org/ghc/ghc/issues/1544): `Read1` instances
...
- The notorious state hack, and `replicateM` in particular
  ...
  - [\#1168](https://gitlab.staging.haskell.org/ghc/ghc/issues/1168) has a list of related tickets
  - [\#11677](https://gitlab.staging.haskell.org/ghc/ghc/issues/11677)
  - [\#11365](https://gitlab.staging.haskell.org/ghc/ghc/issues/11365)
  - [\#6166](https://gitlab.staging.haskell.org/ghc/ghc/issues/6166): apparently something with NOINLINE is getting inlined 
  - [\#9388](https://gitlab.staging.haskell.org/ghc/ghc/issues/9388) has ideas and preliminary work on how to limit the scope of the hack
  - Search for "`replicateM`" to find other tickets
  - [\#7411](https://gitlab.staging.haskell.org/ghc/ghc/issues/7411): state hack changes exception semantics
  - [\#2284](https://gitlab.staging.haskell.org/ghc/ghc/issues/2284), [\#1168](https://gitlab.staging.haskell.org/ghc/ghc/issues/1168), [\#7561](https://gitlab.staging.haskell.org/ghc/ghc/issues/7561), [\#9349](https://gitlab.staging.haskell.org/ghc/ghc/issues/9349): the state-hack "optimisation" causes much re-computation
...
- [\#12201](https://gitlab.staging.haskell.org/ghc/ghc/issues/12201): overlapping instances and instance declarations
- [\#11515](https://gitlab.staging.haskell.org/ghc/ghc/issues/11515): better computation for constraint holes
...
- [\#9210](https://gitlab.staging.haskell.org/ghc/ghc/issues/9210), [\#10675](https://gitlab.staging.haskell.org/ghc/ghc/issues/10675): functional dependencies and overlapping instances
...
- [\#9450](https://gitlab.staging.haskell.org/ghc/ghc/issues/9450): need more eager checking of compatibility with hs-boot files
...
- [\#10267](https://gitlab.staging.haskell.org/ghc/ghc/issues/10267): typed holes and TH
- [\#10548](https://gitlab.staging.haskell.org/ghc/ghc/issues/10548): partial type sigs and TH
- [\#10047](https://gitlab.staging.haskell.org/ghc/ghc/issues/10047): inconsistency in name binding between splice and quasiquotation
- [\#10486](https://gitlab.staging.haskell.org/ghc/ghc/issues/10486): allow `addTopDecls` to create annotations
- [\#10541](https://gitlab.staging.haskell.org/ghc/ghc/issues/10541): reify kind information
- [\#10385](https://gitlab.staging.haskell.org/ghc/ghc/issues/10385): TH and annotations
- [\#10279](https://gitlab.staging.haskell.org/ghc/ghc/issues/10279), [wiki page](template-haskell/package-key-changes): `reifyPackage`
...
- [\#2041](https://gitlab.staging.haskell.org/ghc/ghc/issues/2041): Splicing in concrete syntax
...
- [\#4222](https://gitlab.staging.haskell.org/ghc/ghc/issues/4222): design of reification for TH

## Demand analysis and CSE


- [\#10918](https://gitlab.staging.haskell.org/ghc/ghc/issues/10918): float in used-once things into recursive bindings
- [\#7782](https://gitlab.staging.haskell.org/ghc/ghc/issues/7782): late demand analysis
- [\#10069](https://gitlab.staging.haskell.org/ghc/ghc/issues/10069): bad reboxing in data types with many fields
- [\#8655](https://gitlab.staging.haskell.org/ghc/ghc/issues/8655): analysis for quick-to-evaluate thunks
...
- [\#10678](https://gitlab.staging.haskell.org/ghc/ghc/issues/10678), [\#2289](https://gitlab.staging.haskell.org/ghc/ghc/issues/2289), [\#2387](https://gitlab.staging.haskell.org/ghc/ghc/issues/2387), [\#1600](https://gitlab.staging.haskell.org/ghc/ghc/issues/1600), [\#1885](https://gitlab.staging.haskell.org/ghc/ghc/issues/1885): nested CPR analysis
- [\#7596](https://gitlab.staging.haskell.org/ghc/ghc/issues/7596), [\#5996](https://gitlab.staging.haskell.org/ghc/ghc/issues/5996), [\#149](https://gitlab.staging.haskell.org/ghc/ghc/issues/149), [\#2940](https://gitlab.staging.haskell.org/ghc/ghc/issues/2940), [\#947](https://gitlab.staging.haskell.org/ghc/ghc/issues/947), [\#701](https://gitlab.staging.haskell.org/ghc/ghc/issues/701), [\#5344](https://gitlab.staging.haskell.org/ghc/ghc/issues/5344), [\#9441](https://gitlab.staging.haskell.org/ghc/ghc/issues/9441): CSE opportunities; see [MoreCSE](more-cse)
...
- [\#10181](https://gitlab.staging.haskell.org/ghc/ghc/issues/10181): unsound eta-reduction
- [\#11029](https://gitlab.staging.haskell.org/ghc/ghc/issues/11029): eta expansion causes slow-down
- [\#11146](https://gitlab.staging.haskell.org/ghc/ghc/issues/11146): manual eta expansion is a big win
- [\#10260](https://gitlab.staging.haskell.org/ghc/ghc/issues/10260), [\#9020](https://gitlab.staging.haskell.org/ghc/ghc/issues/9020), [\#10319](https://gitlab.staging.haskell.org/ghc/ghc/issues/10319): not enough eta expansion
- [\#7542](https://gitlab.staging.haskell.org/ghc/ghc/issues/7542): optimisation of eta expansion/reduction
- [\#5809](https://gitlab.staging.haskell.org/ghc/ghc/issues/5809): arity analysis could be better
...
- [\#1547](https://gitlab.staging.haskell.org/ghc/ghc/issues/1547): profiling and arity
- [\#5587](https://gitlab.staging.haskell.org/ghc/ghc/issues/5587), [\#7364](https://gitlab.staging.haskell.org/ghc/ghc/issues/7364): eta-expansion can imcrease termination.  These tickets are closed because we don't know how to fix them properly, not becuase they are really fixed.
...
- [\#11475](https://gitlab.staging.haskell.org/ghc/ghc/issues/11475): Lint should check for inexhaustive cases expressions
- [\#9476](https://gitlab.staging.haskell.org/ghc/ghc/issues/9476): late lambda lifting
- [\#7374](https://gitlab.staging.haskell.org/ghc/ghc/issues/7374), [\#10417](https://gitlab.staging.haskell.org/ghc/ghc/issues/10417), [\#10418](https://gitlab.staging.haskell.org/ghc/ghc/issues/10418), [\#7287](https://gitlab.staging.haskell.org/ghc/ghc/issues/7287), [\#7398](https://gitlab.staging.haskell.org/ghc/ghc/issues/7398), [\#10528](https://gitlab.staging.haskell.org/ghc/ghc/issues/10528), [\#11688](https://gitlab.staging.haskell.org/ghc/ghc/issues/11688), [\#10595](https://gitlab.staging.haskell.org/ghc/ghc/issues/10595), [\#7141](https://gitlab.staging.haskell.org/ghc/ghc/issues/7141), [\#5973](https://gitlab.staging.haskell.org/ghc/ghc/issues/5973), [\#2271](https://gitlab.staging.haskell.org/ghc/ghc/issues/2271), [\#1434](https://gitlab.staging.haskell.org/ghc/ghc/issues/1434): rules not firing; e.g. class methods, newtype constructors
...
- [\#10528](https://gitlab.staging.haskell.org/ghc/ghc/issues/10528), [\#10595](https://gitlab.staging.haskell.org/ghc/ghc/issues/10595): RULES for class methods
...
- [\#9370](https://gitlab.staging.haskell.org/ghc/ghc/issues/9370), [\#8635](https://gitlab.staging.haskell.org/ghc/ghc/issues/8635): respecting mixed `-O` and `-O0` in `ghc --make`, especially concerning cross-module inlining
...
- [\#8317](https://gitlab.staging.haskell.org/ghc/ghc/issues/8317), [\#8326](https://gitlab.staging.haskell.org/ghc/ghc/issues/8326), [\#9661](https://gitlab.staging.haskell.org/ghc/ghc/issues/9661), [\#12231](https://gitlab.staging.haskell.org/ghc/ghc/issues/12231), [\#2289](https://gitlab.staging.haskell.org/ghc/ghc/issues/2289): don't push heapchecks into case branches too aggressively.  This is closely related to work Jan Stolarek did on unboxed booleans [\#6135](https://gitlab.staging.haskell.org/ghc/ghc/issues/6135); and perhaps also to [\#10124](https://gitlab.staging.haskell.org/ghc/ghc/issues/10124), [\#10137](https://gitlab.staging.haskell.org/ghc/ghc/issues/10137)
- [\#8308](https://gitlab.staging.haskell.org/ghc/ghc/issues/8308): resurrect ticky histograms
- [\#8321](https://gitlab.staging.haskell.org/ghc/ghc/issues/8321): branch prediction for stack/heap checks for LLVM
- [\#8279](https://gitlab.staging.haskell.org/ghc/ghc/issues/8279): alignment and its effect on performance
- [\#1498](https://gitlab.staging.haskell.org/ghc/ghc/issues/1498): heap checks in recursive functions
...
- [\#2439](https://gitlab.staging.haskell.org/ghc/ghc/issues/2439): Strict dictionaries; see also map/coerce rule [\#9792](https://gitlab.staging.haskell.org/ghc/ghc/issues/9792)
- [\#5916](https://gitlab.staging.haskell.org/ghc/ghc/issues/5916), [\#10678](https://gitlab.staging.haskell.org/ghc/ghc/issues/10678): `runST` isn't free
...
- [\#3990](https://gitlab.staging.haskell.org/ghc/ghc/issues/3990), [\#7647](https://gitlab.staging.haskell.org/ghc/ghc/issues/7647): UNPACK for data families, and with phantom types, needs data con wrapper refactoring; see also [\#9655](https://gitlab.staging.haskell.org/ghc/ghc/issues/9655) if you are in this area.
...
- [\#10555](https://gitlab.staging.haskell.org/ghc/ghc/issues/10555): division primops on LHS of a RULE
- [\#9407](https://gitlab.staging.haskell.org/ghc/ghc/issues/9407): 64-bit floating point behaves differently with and without -O
- [\#5780](https://gitlab.staging.haskell.org/ghc/ghc/issues/5780): aggressive-primop attempt that didn't quite work
- [\#9328](https://gitlab.staging.haskell.org/ghc/ghc/issues/9328), [\#10215](https://gitlab.staging.haskell.org/ghc/ghc/issues/10215): negative zero and case expressions
- [\#9304](https://gitlab.staging.haskell.org/ghc/ghc/issues/9304): floating point woes: 32 vs 64 bit
- [\#5615](https://gitlab.staging.haskell.org/ghc/ghc/issues/5615): poor code for div with powers of 2
...
- [\#9276](https://gitlab.staging.haskell.org/ghc/ghc/issues/9276): auditing for IEEE compliance

## Features


- [\#9049](https://gitlab.staging.haskell.org/ghc/ghc/issues/9049): explicit call stack, abstractable call site information
- [\#5972](https://gitlab.staging.haskell.org/ghc/ghc/issues/5972): option to suppress record selectors
...
- [\#9157](https://gitlab.staging.haskell.org/ghc/ghc/issues/9157): common block elimination
- [\#8905](https://gitlab.staging.haskell.org/ghc/ghc/issues/8905): spilling around an eval
- [\#8903](https://gitlab.staging.haskell.org/ghc/ghc/issues/8903): dead stores
- [\#8887](https://gitlab.staging.haskell.org/ghc/ghc/issues/8887): double assignment
- [\#8871](https://gitlab.staging.haskell.org/ghc/ghc/issues/8871): Cmm optimisation opportunity
- [\#8585](https://gitlab.staging.haskell.org/ghc/ghc/issues/8585), [\#11372](https://gitlab.staging.haskell.org/ghc/ghc/issues/11372): loopification; see also [Commentary/Compiler/Loopification](commentary/compiler/loopification)
- Summary ticket: [\#4258](https://gitlab.staging.haskell.org/ghc/ghc/issues/4258), and [wiki page](commentary/compiler/new-code-gen)
...
- [\#4121](https://gitlab.staging.haskell.org/ghc/ghc/issues/4121): arity and CAF info computation is horribly fragile

### Optimiser


- [\#10346](https://gitlab.staging.haskell.org/ghc/ghc/issues/10346), [\#2255](https://gitlab.staging.haskell.org/ghc/ghc/issues/2255), [\#3767](https://gitlab.staging.haskell.org/ghc/ghc/issues/3767), [\#2642](https://gitlab.staging.haskell.org/ghc/ghc/issues/2642), [\#3831](https://gitlab.staging.haskell.org/ghc/ghc/issues/3831), [\#4941](https://gitlab.staging.haskell.org/ghc/ghc/issues/4941), [\#2598](https://gitlab.staging.haskell.org/ghc/ghc/issues/2598): Improve **`SpecConstr`** in various ways, including for free variables, and for join points.
...
- [\#4470](https://gitlab.staging.haskell.org/ghc/ghc/issues/4470): merge identical counters
- [\#2988](https://gitlab.staging.haskell.org/ghc/ghc/issues/2988), [\#11197](https://gitlab.staging.haskell.org/ghc/ghc/issues/11197): better float-in
...
- [\#9394](https://gitlab.staging.haskell.org/ghc/ghc/issues/9394): Display type/data family instance information in `:info`
...
- [\#10338](https://gitlab.staging.haskell.org/ghc/ghc/issues/10338): delicacy in generalisation: `MonoLocalBinds` isn't enough
- [\#9637](https://gitlab.staging.haskell.org/ghc/ghc/issues/9637): type level error messages
- [\#9587](https://gitlab.staging.haskell.org/ghc/ghc/issues/9587), [\#9607](https://gitlab.staging.haskell.org/ghc/ghc/issues/9607): `-XAllowAmbiguousTypes` debate
- [\#9334](https://gitlab.staging.haskell.org/ghc/ghc/issues/9334): instance chains
...
- [\#4466](https://gitlab.staging.haskell.org/ghc/ghc/issues/4466), [\#5296](https://gitlab.staging.haskell.org/ghc/ghc/issues/5296), [\#8631](https://gitlab.staging.haskell.org/ghc/ghc/issues/8631): explicit type application
...
- [\#10450](https://gitlab.staging.haskell.org/ghc/ghc/issues/10450): poor error message when arg is insufficiently polymorphic
- [\#9901](https://gitlab.staging.haskell.org/ghc/ghc/issues/9901): `f is applied to two arguments, but its type has only two`
- [\#9456](https://gitlab.staging.haskell.org/ghc/ghc/issues/9456): more info in "relevant bindings" message
- [\#9244](https://gitlab.staging.haskell.org/ghc/ghc/issues/9244): suggest scoped type variables
- [\#9173](https://gitlab.staging.haskell.org/ghc/ghc/issues/9173): inferred/expected error messages
...
- [\#2895](https://gitlab.staging.haskell.org/ghc/ghc/issues/2895): Class aliases 
