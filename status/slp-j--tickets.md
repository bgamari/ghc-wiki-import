 ...
 * #4856: slow typechecking (regression)
 * #5051: typechecker behaviour change
 * #5030: slow typechecking
 * #5002: context ignored
 * #4981: inconsistent class reqts
 * #2021: equality superclasses (when we have the new coercion rep)


 * #4347: rigid type signatures for impredicativity
 
 * #1999: this relates to decomposition of type application in GADTs etc, which we no longer support.  We could start supporting it again, but the question is whether it's worth the extra complexity.
...
=== Other performance ===
 * #5028: extra `let x=y` binding left around after `CorePrep`
 ...
 * #4404: wrong "defined but not used" message with `RecordWildCards`
 ...
 * #4338, #2102, #2715: superclass equalities
 ...
 * #4809, #4370, #3731: loopy superclass behaviour; make sure all these work!
