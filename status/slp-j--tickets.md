...
- [\#7994](https://gitlab.staging.haskell.org/ghc/ghc/issues/7994): Make foldl into a good consumer; needs better arity analysis
...
- [\#8351](https://gitlab.staging.haskell.org/ghc/ghc/issues/8351): inline allocation for small arrays
...
- [\#6135](https://gitlab.staging.haskell.org/ghc/ghc/issues/6135): unboxed booleans
...
- [\#7898](https://gitlab.staging.haskell.org/ghc/ghc/issues/7898)k [\#7068](https://gitlab.staging.haskell.org/ghc/ghc/issues/7068): `SpecConstr` blowup
...
- [\#7856](https://gitlab.staging.haskell.org/ghc/ghc/issues/7856): function type decomposed a bit too eagerly =\> worse error
