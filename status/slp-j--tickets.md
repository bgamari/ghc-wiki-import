...
- [\#5075](https://gitlab.staging.haskell.org/ghc/ghc/issues/5075): CPR for sum types (mostly done, needs finishing)
- [\#5996](https://gitlab.staging.haskell.org/ghc/ghc/issues/5996), [\#149](https://gitlab.staging.haskell.org/ghc/ghc/issues/149), [\#2940](https://gitlab.staging.haskell.org/ghc/ghc/issues/2940): CSE (patch offered)
...
- [\#6040](https://gitlab.staging.haskell.org/ghc/ghc/issues/6040), [\#5945](https://gitlab.staging.haskell.org/ghc/ghc/issues/5945): lambda-lift functions with a few args, just before code gen
...
- [\#2132](https://gitlab.staging.haskell.org/ghc/ghc/issues/2132): Optimise nested comparisons: if you know x\>0 then you know x\>=1 etc.  Maybe a special pass that knows about arithmetic?  (Patch offered)
