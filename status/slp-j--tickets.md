 ...
 * #10519: partial type sig bug (Thomas W is working on this)
 ...
 * #10491: In `accelerate`, simplifier blows up size of term by factor of 100.  Regression from 7.8.
 * #10370: `OpenGLRaw`
 ...
 * #10293: too much time in `CallArity` (Joachim)
