...
- [\#9858](https://gitlab.staging.haskell.org/ghc/ghc/issues/9858): `Typeable` should be kind-aware.
...
- [\#9370](https://gitlab.staging.haskell.org/ghc/ghc/issues/9370): massive blow-up unless you switch off all optimisation
...
- [\#8317](https://gitlab.staging.haskell.org/ghc/ghc/issues/8317), [\#8326](https://gitlab.staging.haskell.org/ghc/ghc/issues/8326), [\#9661](https://gitlab.staging.haskell.org/ghc/ghc/issues/9661): don't push heapchecks into case branches too aggressively.  This is closely related to work Jan Stolarek did on unboxed booleans.
...
- [\#9328](https://gitlab.staging.haskell.org/ghc/ghc/issues/9328): negative zero and case expressions
- [\#9304](https://gitlab.staging.haskell.org/ghc/ghc/issues/9304): floating point woes: 32 vs 64 bit
- [\#7858](https://gitlab.staging.haskell.org/ghc/ghc/issues/7858): `abs` on negative zero
...
- [\#9497](https://gitlab.staging.haskell.org/ghc/ghc/issues/9497): typed holes: silencing them
...
- [\#3714](https://gitlab.staging.haskell.org/ghc/ghc/issues/3714): distinguish type parameters from indices
...
- [\#4921](https://gitlab.staging.haskell.org/ghc/ghc/issues/4921): ambiguous type variables
...
- [\#5248](https://gitlab.staging.haskell.org/ghc/ghc/issues/5248): Infer context in type signatures
