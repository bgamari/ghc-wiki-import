 ...
 * #9858: `Typeable` should be kind-aware.
 * #10031: `Coercible` makes compiler loop
 * #9960, #9805: `TrieMap` stuff
 * #10016: UNPACK support for existentials
 * #9260: type lits (Iavor owns)
 * #9953, #9900, #9867, #9891, #9793, #8761, #8581, #8779, #8761, #8583, #9911, #9889: pattern synonyms (Gergo)
 ...
 * #9951, #595, #5728, #3927, #5724, #5762, #4139, #6124, #7669, #322, #8016, #8494, #8853, #8970, #9113, #2204: '''pattern-match overlap checking''', including with GADTs
