...
- [\#4856](https://gitlab.staging.haskell.org/ghc/ghc/issues/4856): slow typechecking (regression)
- [\#5051](https://gitlab.staging.haskell.org/ghc/ghc/issues/5051): typechecker behaviour change
- [\#5030](https://gitlab.staging.haskell.org/ghc/ghc/issues/5030): slow typechecking
- [\#5002](https://gitlab.staging.haskell.org/ghc/ghc/issues/5002): context ignored
- [\#4981](https://gitlab.staging.haskell.org/ghc/ghc/issues/4981): inconsistent class reqts
- [\#2021](https://gitlab.staging.haskell.org/ghc/ghc/issues/2021): equality superclasses (when we have the new coercion rep)

- [\#4347](https://gitlab.staging.haskell.org/ghc/ghc/issues/4347): rigid type signatures for impredicativity


 


- [\#1999](https://gitlab.staging.haskell.org/ghc/ghc/issues/1999): this relates to decomposition of type application in GADTs etc, which we no longer support.  We could start supporting it again, but the question is whether it's worth the extra complexity.
...
- [\#4227](https://gitlab.staging.haskell.org/ghc/ghc/issues/4227): SPECIALISE pragmas for functions in other modules
...
- [\#3132](https://gitlab.staging.haskell.org/ghc/ghc/issues/3132): fix cgCase of PrimAlts
...
- [\#5028](https://gitlab.staging.haskell.org/ghc/ghc/issues/5028): extra `let x=y` binding left around after `CorePrep`
...
- [\#2281](https://gitlab.staging.haskell.org/ghc/ghc/issues/2281): properFraction implemented with modf primitive?
...
- [\#4404](https://gitlab.staging.haskell.org/ghc/ghc/issues/4404): wrong "defined but not used" message with `RecordWildCards`
...
- [\#4295](https://gitlab.staging.haskell.org/ghc/ghc/issues/4295): Higher rank and impredicative 
- [\#4338](https://gitlab.staging.haskell.org/ghc/ghc/issues/4338), [\#2102](https://gitlab.staging.haskell.org/ghc/ghc/issues/2102), [\#2715](https://gitlab.staging.haskell.org/ghc/ghc/issues/2715): superclass equalities
- [\#4310](https://gitlab.staging.haskell.org/ghc/ghc/issues/4310): deferred equalities and forall types (needs Brent's work)
...
- [\#4809](https://gitlab.staging.haskell.org/ghc/ghc/issues/4809), [\#4370](https://gitlab.staging.haskell.org/ghc/ghc/issues/4370), [\#3731](https://gitlab.staging.haskell.org/ghc/ghc/issues/3731): loopy superclass behaviour; make sure all these work!
...
- [\#4466](https://gitlab.staging.haskell.org/ghc/ghc/issues/4466): explicit type application
...
- [\#1496](https://gitlab.staging.haskell.org/ghc/ghc/issues/1496), [\#4846](https://gitlab.staging.haskell.org/ghc/ghc/issues/4846): Newtype deriving and type families type soundness problem
...
- [\#4372](https://gitlab.staging.haskell.org/ghc/ghc/issues/4372): better quasiquotes
- [\#4359](https://gitlab.staging.haskell.org/ghc/ghc/issues/4359): lambda case
- [\#4370](https://gitlab.staging.haskell.org/ghc/ghc/issues/4370): monad comprehensions
