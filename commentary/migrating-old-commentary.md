...
Below you will find a table with a line for each section of the [http://darcs.haskell.org/ghc/docs/comm/ old commentary].  Please replace ''unknown'' with '''done''' if you believe
...
||Coding style used in the compiler||''unknown''||
||The Glorious Driver||''unknown''||
...
||Coding Style Guidelines||''unknown''||
