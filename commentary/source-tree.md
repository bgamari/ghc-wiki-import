...
Everything starts with the main GHC repository (see [wiki:Building/GettingTheSources]).   The biuld system calls that directory `$(TOP)`.  All the paths below are relative to `$(TOP)`.
