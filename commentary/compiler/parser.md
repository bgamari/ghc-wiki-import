 ...
 * Happy, for the parser itself.  Source file [[GhcFile(compiler/parser/Parser.y.pp)]].  Note the `.pp` suffix; do not edit `Parser.y`!  [I forget how it's preprocessed to get from `.y.pp` to `.y`]
