...
This page summarises work that Norman Ramsey, Simon M, Simon PJ, and John Dias are doing on re-architecting GHC's back end. You may want to see the [wiki:Commentary/Compiler/NewCodeGenPipeline short-term view of the pipeline].
