...
- Fixed-point algorithm rewritten to reduce duplicate computation.  (Simon Marlow in late 2011.  Also Edward Yang in spring 2011.  There is still some work to be done here (easily seen if you try tracing some of the simple examples in the Hoopl repository) but a more clever iterative sweeping algorithm languishing in my repository suffers from a subtle bug that surfaces when tested on GHC. -- ezyang
