...
- There are still some cases where an interface can change without changing the source code.  The ones we know about are listed in [\#4012](https://gitlab.staging.haskell.org/ghc/ghc/issues/4012)
