...
The following tickets are related to register allocation: [\#8048](https://gitlab.staging.haskell.org/ghc/ghc/issues/8048) [\#10012](https://gitlab.staging.haskell.org/ghc/ghc/issues/10012) [\#12232](https://gitlab.staging.haskell.org/ghc/ghc/issues/12232)
...
- **Visualisation of conflict graphs**
  ...
  Graphviz, available from [
  http://www.graphviz.org](http://www.graphviz.org) can be used to make nice visualisations of the register conflict graphs. Use `-ddump-asm-regalloc-stages`, and copy one of the graph descriptions into a new file `niceGraph.dot`
