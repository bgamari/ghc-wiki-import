 ...
 * ARM: Some work has been done testing GHC in unregisterised mode with LLVM on ARM. You can see a blog with info about this [http://ghcarm.wordpress.com/ here].
