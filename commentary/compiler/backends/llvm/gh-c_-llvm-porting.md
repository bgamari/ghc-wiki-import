...
2. You will need to implement a custom calling convention for LLVM for your platform
...
4. Add new inline assembly code for your platform to ghc's RTS. See files like
