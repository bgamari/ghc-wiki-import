...
Starting with GHC 7.10 ([\#8407](https://gitlab.staging.haskell.org/ghc/ghc/issues/8407)), we will have support for reexporting modules from other packages you depend upon.  How does this work?
