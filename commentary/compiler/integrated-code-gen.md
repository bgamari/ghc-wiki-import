...
Pipeline
 ...
 0. Build control-flow graph: Cmm -> ZGraphCmm<variables, stack slots, compile-time constants>
 ...
 0. Code expansion (instruction selection): ZGraph Cmm<variables, stack slots, compile-time constants> -> ZGraph Instrs<variables, stack slots, compile-time constants>
 ...
 0. Optimizer: ZGraph Instrs<variables, stack slots, compile-time constants> -> ZGraph Instrs<variables, stack slots, compile-time constants>
 0. Proc-point analysis: ZGraph Instrs<variables, stack slots, compile-time constants> -> [ZGraph Instrs<variables, stack slots, compile-time constants>]
 ...
 0. Register allocation: ZGraph Instrs<variables, stack slots, compile-time constants> -> ZGraph Instrs<stack slots, compile-time constants>
  * Replace variable references with machine register and stack slots.
 0. Stack Layout: ZGraph Instrs<> -> ZGraph Instrs<>
 ...
 0. Proc-point splitting: ZGraph Instrs<> -> [ZGraph Instrs<>]
  * Each proc point gets its own procedure.
 0. Code emission: ZGraph Instrs<> -> String
  * Assembly code ahoy!
