...
The material below describes the old (and still current) code generator.  New stuff is here:
  * [wiki:Commentary/Compiler/CPS Michael Adams CPS conversion]
  * [wiki:Commentary/Compiler/NewCodeGen New code generator]

The code generator lives in [[GhcFile(compiler/codeGen)]]
