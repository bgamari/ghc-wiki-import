...
> >
> >
> > It currently does not eliminate dead code in loops ([\#8327](https://gitlab.staging.haskell.org/ghc/ghc/issues/8327)) and has some other minor deficiencies (eg. [\#8336](https://gitlab.staging.haskell.org/ghc/ghc/issues/8336)).
> >
> >
>
