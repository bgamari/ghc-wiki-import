...
flags, including [\#1148](https://gitlab.staging.haskell.org/ghc/ghc/issues/1148), [\#2267](https://gitlab.staging.haskell.org/ghc/ghc/issues/2267), [\#1074](https://gitlab.staging.haskell.org/ghc/ghc/issues/1074), [\#2436](https://gitlab.staging.haskell.org/ghc/ghc/issues/2436), [\#10117](https://gitlab.staging.haskell.org/ghc/ghc/issues/10117), [\#12067](https://gitlab.staging.haskell.org/ghc/ghc/issues/12067).
...
The unqualified `x` can only come from import [\#2](https://gitlab.staging.haskell.org/ghc/ghc/issues/2).  The qualified `M.x`
could come from either, but bestImport picks import [\#2](https://gitlab.staging.haskell.org/ghc/ghc/issues/2), because it is
more likely to be useful in other imports, as indeed it is in this
case (see Trac [\#5211](https://gitlab.staging.haskell.org/ghc/ghc/issues/5211) for a concrete example).
