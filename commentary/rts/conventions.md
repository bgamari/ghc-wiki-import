...
informative) or mail someone (eg. [mailto:glasgow-haskell-users@haskell.org The GHC mailing list])
 ...
 * The C99 standard.  One reasonable reference is [http://home.tiscalinet.ch/t_wolf/tw/c/c9x_changes.html here].

 * Writing Solid Code, Microsoft Press.  (Highly recommended.)

 * Autoconf documentation.  See also
   [http://peti.gmd.de/autoconf-archive/ The autoconf macro archive]
   and [http://www.cyclic.com/cyclic-pages/autoconf.html Cyclic Software's description].

 * [http://www.cs.umd.edu/users/cml/cstyle/indhill-cstyle.html Indian Hill C Style and Coding Standards]

 * [http://www.cs.umd.edu/users/cml/cstyle/ A list of C programming style links]

 * [http://www.lysator.liu.se/c/c-www.html A very large list of C programming links]

 * [http://www.geek-girl.com/unix.html A list of Unix programming links]
