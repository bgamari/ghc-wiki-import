...
http://hackage.haskell.org/trac/ghc/wiki/Commentary/Packages/MultiInstances](http://hackage.haskell.org/trac/ghc/wiki/Commentary/Packages/MultiInstances)(this wiki entry) the following changes need to be made:
