...
<td>
Hash of source code sdist tarball, selected Cabal flags (not the command line flags), GHC flags, hashes of direct dependencies of the component (the `build-depends` of the library in the Cabal file), and the name of the component. See [
https://github.com/haskell/cabal/pull/2846](https://github.com/haskell/cabal/pull/2846)
</td></tr></table>
