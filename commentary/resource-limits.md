...
[compiler/codeGen/StgCmmBind.hs](/trac/ghc/browser/ghc/compiler/codeGen/StgCmmBind.hs):link\_caf
...
```wiki
         ...
         I64[Sp - 32] = stg_upd_frame_info;
         I64[Sp - 8] = R1;
         I64[Sp - 24] = CurrentResourceContainer; // so we can restore it on return, NOT the same as nursery
         // XXX Update CurrentResourceContainer
         // (load free variables)
         ...
     clg: jump stg_gc_enter_1; // [R1]
     cli:
