...
Versioning of GHC core/boot libraries adheres to Haskell's [https://wiki.haskell.org/Package_versioning_policy Package Versioning Policy] whose scope is considered to apply to **released artifacts** (and therefore doesn't prescribe when to //actually// perform version increments during development)
