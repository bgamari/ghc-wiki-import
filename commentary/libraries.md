...
- **Independent** packages are loosely coupled to GHC, and often maintained by others.  Most boot pcakges are independent; e.g. `containers`, `binary`, `haskeline` and so on.  
