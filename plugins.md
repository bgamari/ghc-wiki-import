...
data GHCPluginInstance = GHCPluginInstance {
  ...
  -- TODO: work out the best way to allow plugins to specify link artifacts
}
...
The compiler needs to bring the plugin writer and users contributions together. A possible game plan might be:
 0. Check for plugins referenced on the command line and give them a chance to parse command
