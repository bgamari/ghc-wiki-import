...
The first one was actually already implemented, so we compared in-thunk-limit=10 with free-variables-limit=10.
...
```wiki
driver.sh x 15
                              baseline       in-thunk=10      free-vars=10
           atom                 3.66           -0.8%           -1.2%
      cacheprof                 2.06           +5.4%           +2.4%
...
TODO ~/nofib-logs/22-feb-2013/round2-it10-vs-lam10
```
...
- try making all dictionaries strict (simultaneously drop the newtype-single-method trick)
