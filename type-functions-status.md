 ...
 * #2202 (Uses `a ~ MeshVertex a b` in `normaliseWantedDicts` w/o the occurs check kicking in; also occurs in 6.8.2 ad the program doesn't mention TFs, so need to merge)
