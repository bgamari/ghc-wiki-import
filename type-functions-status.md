...
- Solving of equalities (`TcTyFuns`):
  ...
  - [\#2235](https://gitlab.staging.haskell.org/ghc/ghc/issues/2235), [\#1775](https://gitlab.staging.haskell.org/ghc/ghc/issues/1775) & test `GADT1` (bogus occurs check failure - in both bugs, the loop is through a TF)
