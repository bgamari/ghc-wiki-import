...
- Misc:
  ...
  - [\#2999](https://gitlab.staging.haskell.org/ghc/ghc/issues/2999) (should go away once we don't update coercion and unification variables during equality solving, but return a set of type variable bindings)
  - [\#2658](https://gitlab.staging.haskell.org/ghc/ghc/issues/2658)
