...
- [\#1809](https://gitlab.staging.haskell.org/ghc/ghc/issues/1809)
- [\#1775](https://gitlab.staging.haskell.org/ghc/ghc/issues/1775)
- [\#1754](https://gitlab.staging.haskell.org/ghc/ghc/issues/1754) & [\#1808](https://gitlab.staging.haskell.org/ghc/ghc/issues/1808)
- [\#1716](https://gitlab.staging.haskell.org/ghc/ghc/issues/1716) (maybe the same problem as [\#1754](https://gitlab.staging.haskell.org/ghc/ghc/issues/1754))
- [\#1772](https://gitlab.staging.haskell.org/ghc/ghc/issues/1772)
- [\#1815](https://gitlab.staging.haskell.org/ghc/ghc/issues/1815) (type families & GADTs)
...
- [\#1716](https://gitlab.staging.haskell.org/ghc/ghc/issues/1716) (bogus evidence generation with type equalities)
- [\#1715](https://gitlab.staging.haskell.org/ghc/ghc/issues/1715) (iface problem, which is tricky to reproduce...not anymore, also appears in package ndp)
