...
- GADT:
  ...
  - [\#2627](https://gitlab.staging.haskell.org/ghc/ghc/issues/2627) (GADT-TF interaction)
...
- Misc:
  ...
  - [\#2296](https://gitlab.staging.haskell.org/ghc/ghc/issues/2296): error message involving fundep gives unhelpful location.  I want to remember to come back to this one when we have the new type-family simplification stuff in place.
