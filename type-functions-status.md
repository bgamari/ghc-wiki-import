...
- Declarations involving families:
  ...
  - [\#3197](https://gitlab.staging.haskell.org/ghc/ghc/issues/3197) (problem with qualified names in type instance heads)
  - [\#2677](https://gitlab.staging.haskell.org/ghc/ghc/issues/2677) (depending on the order of instances, overlap is sometimes not properly recognised)
  - Test`Simple8`:
...
- Misc:
  ...
  - [\#3297](https://gitlab.staging.haskell.org/ghc/ghc/issues/3297): `flattenType` error
  - [\#3220](https://gitlab.staging.haskell.org/ghc/ghc/issues/3220) (generalisation)
  - [\#3208](https://gitlab.staging.haskell.org/ghc/ghc/issues/3208): panic `idInfo` of a coercion variable
