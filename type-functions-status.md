...
- GADT:
  ...
  - [\#2366](https://gitlab.staging.haskell.org/ghc/ghc/issues/2366) (Assertion failure in `writeMetaTyVar` with -DDEBUG on gadt/equal; see also below)
...
- [\#2212](https://gitlab.staging.haskell.org/ghc/ghc/issues/2212)
...
- [\#2151](https://gitlab.staging.haskell.org/ghc/ghc/issues/2151) (GADT)
