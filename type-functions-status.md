...
- Add the program of [\#1900](https://gitlab.staging.haskell.org/ghc/ghc/issues/1900) & [\#1999](https://gitlab.staging.haskell.org/ghc/ghc/issues/1999)
...
- Solving of equalities (`TcTyFuns`):
  ...
  - [\#2219](https://gitlab.staging.haskell.org/ghc/ghc/issues/2219) & [\#2235](https://gitlab.staging.haskell.org/ghc/ghc/issues/2235) (bogus occurs check failure - in both bugs, the loop is through a TF)
...
- [\#1897](https://gitlab.staging.haskell.org/ghc/ghc/issues/1897) (confusing error message)
- [\#1834](https://gitlab.staging.haskell.org/ghc/ghc/issues/1834)
- [\#1775](https://gitlab.staging.haskell.org/ghc/ghc/issues/1775)
- [\#1772](https://gitlab.staging.haskell.org/ghc/ghc/issues/1772)
...
1. Allow data family GADT instances [\#1968](https://gitlab.staging.haskell.org/ghc/ghc/issues/1968):
