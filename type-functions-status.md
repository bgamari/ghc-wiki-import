...
- Declarations involving families:
  ...
  - [\#3714](https://gitlab.staging.haskell.org/ghc/ghc/issues/3714): scoping error for associated types
  ...
  - [\#2435](https://gitlab.staging.haskell.org/ghc/ghc/issues/2435) (Inconsistency in handling qualification of names of class methods and associated types in instance declarations)
...
- Constraint simplification:
  ...
  - [\#3787](https://gitlab.staging.haskell.org/ghc/ghc/issues/3787): ill-typed program made by typechecker
  - [\#3651](https://gitlab.staging.haskell.org/ghc/ghc/issues/3651): unreachable branches not discovered
  - [\#3584](https://gitlab.staging.haskell.org/ghc/ghc/issues/3584): premature commitment to an instance declaration
  - [\#3554](https://gitlab.staging.haskell.org/ghc/ghc/issues/3554): assertion failure
  - [\#3500](https://gitlab.staging.haskell.org/ghc/ghc/issues/3500): type functions and recursive dictionaries — need to require UndecidableInstances
  - [\#3484](https://gitlab.staging.haskell.org/ghc/ghc/issues/3484): type checker diverges (involves higher rank types)
  - [\#3460](https://gitlab.staging.haskell.org/ghc/ghc/issues/3460): mixed equalities and type classes
  - [\#3208](https://gitlab.staging.haskell.org/ghc/ghc/issues/3208) (another problem with recursive groups that containing signatures with equalities over TFs)
  - [\#3297](https://gitlab.staging.haskell.org/ghc/ghc/issues/3297): Rank-n types: In `TcTyFuns.flattenType`, we need to pull out type families below foralls -maybe pull out if possible, but definitely improve the error message
  - Implicit parameters: In `TcTyFuns`, we need to normalise IP constraints, too (in `normDict` and `substDict`).
  - [\#3330](https://gitlab.staging.haskell.org/ghc/ghc/issues/3330): typechecker goes into a loop
...
- Misc:
  ...
  - [\#2721](https://gitlab.staging.haskell.org/ghc/ghc/issues/2721) (generalised newtype deriving for classes with associated types) Tom S has a use-case for this
...
- [\#3699](https://gitlab.staging.haskell.org/ghc/ghc/issues/3699): wildcards in type function LHSs
- [\#3491](https://gitlab.staging.haskell.org/ghc/ghc/issues/3491): relax restrictions on superclass contexts
...
- [\#3005](https://gitlab.staging.haskell.org/ghc/ghc/issues/3005) & ghci command to print normalised type and add [
