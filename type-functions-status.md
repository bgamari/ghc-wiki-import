...
- Declarations involving families:
  ...
  - [\#3405](https://gitlab.staging.haskell.org/ghc/ghc/issues/3405) (simple fix to pretty printing of family instance headers)
  - [\#3418](https://gitlab.staging.haskell.org/ghc/ghc/issues/3418) (equalities in stupid theta need to be turned into foralls before Core)
...
- Constraint simplification:
  ...
  - [\#2767](https://gitlab.staging.haskell.org/ghc/ghc/issues/2767) & [\#3208](https://gitlab.staging.haskell.org/ghc/ghc/issues/3208) (`idInfo` panic)
...
- Misc:
  ...
  - [\#3422](https://gitlab.staging.haskell.org/ghc/ghc/issues/3422) (deriving)
  - [\#3409](https://gitlab.staging.haskell.org/ghc/ghc/issues/3409) (CoreLint error checking an iface)
