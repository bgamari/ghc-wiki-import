 ...
 * Declarations involving families:
  * #3405 (simple fix to pretty printing of family instance headers)
  * #3418 (equalities in stupid theta need to be turned into foralls before Core)
 ...
 * Misc:
  * #3423 (deriving)
  * #3409 (!CoreLint error checking an iface)
  * #3220 (generalisation)
  * #3064: exponentially slow compile times
  * #3169 & #2360 (improve occurs-check error message in two instances)
  * #2721 (generalised newtype deriving for classes with associated types)
