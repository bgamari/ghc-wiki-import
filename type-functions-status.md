...
1. Dictionary handling for equational constraints:
  ...
  - In the case for ordinary instances in `TcInstDcls.tcInstDecl2`, filter the ids of the super class equalities out of ``map instToId sc\_dicts.  (They don't appear explicitly in the \`Hs' representation of the methods binding.)
