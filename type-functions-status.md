...
- Misc:
  ...
  - [\#2856](https://gitlab.staging.haskell.org/ghc/ghc/issues/2856) (generalised new type deriving for associated data types)
  - [\#2853](https://gitlab.staging.haskell.org/ghc/ghc/issues/2853) (type families and defaulting)
