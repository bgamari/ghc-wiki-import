...
config.guess](https://git.savannah.gnu.org/cgit/autoconf.git/plain/build-aux/config.guess), [
config.sub](https://git.savannah.gnu.org/cgit/autoconf.git/plain/build-aux/config.sub)).
