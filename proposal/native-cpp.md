...
- Fragile semantics, as the "traditional mode" in `cpp` GHC relies on is not well-specified, and therefore implementations disagree in subtle but annoying ways
  ...
  - Clang cpp does not support stringize and string concatenation in traditional mode (see ticket [\#12516](https://gitlab.staging.haskell.org/ghc/ghc/issues/12516))
