...
>
>
> This warning can be controlled via the new flag ~~`-fwarn-mrp-compat`~~ `-Wnoncanonical-monad-instances`, and becomes part of the `-Wall` and `-Wcompat` ([\#11000](https://gitlab.staging.haskell.org/ghc/ghc/issues/11000)) warning-sets, but *not* part of the default warning-set. 
>
>
