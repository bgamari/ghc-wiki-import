...
We can't use `map`, however, to apply a function to all columns, rows, or other sub-arrays of 
...
the shape of the argument determines the shape of the result. In other words, it can't depend on the data
values. 
