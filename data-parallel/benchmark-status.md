...
>
>
> **Status**: Sequential vectorised version does not compile due to a loop in SpecConstr ([\#4831](https://gitlab.staging.haskell.org/ghc/ghc/issues/4831)).
>
>
...
>
>
> **Status**: Sequential vectorised version does not compile due to loop in SpecConstr ([\#4831](https://gitlab.staging.haskell.org/ghc/ghc/issues/4831)). LLVM versions take \>10 min to compile ([\#4838](https://gitlab.staging.haskell.org/ghc/ghc/issues/4838))
>
...
>
>
> **Status**:  -fasm vesions compile but fusion doesn't work so it's very slow. LLVM versions take 30min to compile ([\#4838](https://gitlab.staging.haskell.org/ghc/ghc/issues/4838)) 
>
