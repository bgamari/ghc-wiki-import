...
[[br]]
  ...
  || repa.mmult.c.seq ||  3.792s || 1 || A ||
  || repa.mmult.par.N4 || 2.147s || 1.77 || ||
...
[[br]]
  ...
  || '''name''' || '''runtime''' || '''speedup''' || '''notes'''
  || repa.laplace.c.seq ||  1.299s || 1 || A ||
  || repa.laplace.par.N4 || 2.521s || 0.51 || ||
  A: Straightforward C program using triple nested loops. A cache-friendly block-based version would be faster.

  '''Status:''' Ok, but about 25% slower than in 6.13.[[br]]
...
[[br]]
 [http://darcs.haskell.org/libraries/dph/dph-examples/spectral/QuickSort/ QuickSort] '''(BROKEN)'''::
  ...
  || '''name''' || '''runtime''' || '''speedup''' || '''notes''' ||
  || dph.quicksort.vectorised.par.N1 || 428ms ||  1 || ||
  || dph.quicksort.vectorised.par.N2 || 400ms ||  1.07 || ||
  || dph.quicksort.vectorised.par.N4 || 392ms ||  1.09 || ||
...
[[br]]
 [http://darcs.haskell.org/libraries/dph/dph-examples/spectral/QuickHull/ Quickhull] '''(SLOWLORIS)'''::
  ...
  || dph.quickhull.vector-forkIO.par.N4 || 0.064s ||  2.59 || B ||
