...
The ticket [\#11528](https://gitlab.staging.haskell.org/ghc/ghc/issues/11528) tracks our aspiration to return to a more elegant (but currently less performant) implementation.
...
<tr><th>[\#595](https://gitlab.staging.haskell.org/ghc/ghc/issues/595)</th>
<td>Overhaul GHC's overlapping/non-exhaustive pattern checking</td></tr>
<tr><th>[\#2204](https://gitlab.staging.haskell.org/ghc/ghc/issues/2204)</th>
<td>Improve 'patterns not matched' warnings</td></tr>
<tr><th>[\#3927](https://gitlab.staging.haskell.org/ghc/ghc/issues/3927)</th>
<td>Incomplete/overlapped pattern warnings + GADTs = inadequate</td></tr>
<tr><th>[\#4139](https://gitlab.staging.haskell.org/ghc/ghc/issues/4139)</th>
<td>Spurious non-exhaustive pattern match warnings are given using GADTs</td></tr>
<tr><th>[\#5724](https://gitlab.staging.haskell.org/ghc/ghc/issues/5724)</th>
<td>Confusing warning message for incomplete patterns</td></tr>
<tr><th>[\#5728](https://gitlab.staging.haskell.org/ghc/ghc/issues/5728)</th>
<td>Warnings from -fwarn-incomplete-record-updates even with all constructors matched</td></tr>
<tr><th>[\#5762](https://gitlab.staging.haskell.org/ghc/ghc/issues/5762)</th>
<td>GHC gives incorrect warnings with simple applications of the view patterns extension</td></tr>
<tr><th>[\#6124](https://gitlab.staging.haskell.org/ghc/ghc/issues/6124)</th>
...
<tr><th>[\#8494](https://gitlab.staging.haskell.org/ghc/ghc/issues/8494)</th>
<td>Warn if a pattern guard obviates all others</td></tr>
<tr><th>[\#8710](https://gitlab.staging.haskell.org/ghc/ghc/issues/8710)</th>
<td>Overlapping patterns warning misplaced</td></tr>
<tr><th>[\#8853](https://gitlab.staging.haskell.org/ghc/ghc/issues/8853)</th>
<td>Surprising mention of unboxed integers in pattern exhaustiveness warning</td></tr>
<tr><th>[\#8970](https://gitlab.staging.haskell.org/ghc/ghc/issues/8970)</th>
<td>Non-exhaustive pattern match warning with DataKinds and TypeFamilies</td></tr>
<tr><th>[\#9113](https://gitlab.staging.haskell.org/ghc/ghc/issues/9113)</th>
<td>Template Haskell should warn about non-exhaustive pattern matches</td></tr>
<tr><th>[\#9951](https://gitlab.staging.haskell.org/ghc/ghc/issues/9951)</th>
<td>OverloadedLists breaks exhaustiveness check</td></tr>
<tr><th>[\#10393](https://gitlab.staging.haskell.org/ghc/ghc/issues/10393)</th>
<td>Bogus warning with OverloadedLists</td></tr>
<tr><th>[\#10746](https://gitlab.staging.haskell.org/ghc/ghc/issues/10746)</th>
<td>No non-exhaustive pattern match warning given for empty case analysis</td></tr>
<tr><th>[\#11160](https://gitlab.staging.haskell.org/ghc/ghc/issues/11160)</th>
<td>New exhaustiveness checker breaks ghcirun004</td></tr>
<tr><th>[\#11161](https://gitlab.staging.haskell.org/ghc/ghc/issues/11161)</th>
<td>New exhaustiveness checker breaks concurrent/prog001</td></tr>
<tr><th>[\#11162](https://gitlab.staging.haskell.org/ghc/ghc/issues/11162)</th>
<td>T783 regresses severely in allocations with new pattern match checker</td></tr>
<tr><th>[\#11163](https://gitlab.staging.haskell.org/ghc/ghc/issues/11163)</th>
<td>New exhaustiveness checker breaks T5642</td></tr>
<tr><th>[\#11276](https://gitlab.staging.haskell.org/ghc/ghc/issues/11276)</th>
<td>GHC hangs/takes an exponential amount of time with simple program</td></tr>
<tr><th>[\#11302](https://gitlab.staging.haskell.org/ghc/ghc/issues/11302)</th>
<td>GHC HEAD uses up all memory while compiling \`genprimcode\`</td></tr>
<tr><th>[\#11303](https://gitlab.staging.haskell.org/ghc/ghc/issues/11303)</th>
<td>Pattern matching against sets of strings sharing a prefix blows up pattern checker</td></tr>
<tr><th>[\#11316](https://gitlab.staging.haskell.org/ghc/ghc/issues/11316)</th>
<td>Too many guards warning causes issues</td></tr>
<tr><th>[\#11374](https://gitlab.staging.haskell.org/ghc/ghc/issues/11374)</th>
<td>\`-Woverlapping-patterns\` induced memory-blowup</td></tr>
<tr><th>[\#11390](https://gitlab.staging.haskell.org/ghc/ghc/issues/11390)</th>
<td>GHC does not warn about redundant patterns</td></tr>
<tr><th>[\#11806](https://gitlab.staging.haskell.org/ghc/ghc/issues/11806)</th>
<td>GHC does not warn for mistakenly empty case</td></tr>
<tr><th>[\#11984](https://gitlab.staging.haskell.org/ghc/ghc/issues/11984)</th>
<td>Pattern match incompleteness / inaccessibility discrepancy</td></tr>
<tr><th>[\#12158](https://gitlab.staging.haskell.org/ghc/ghc/issues/12158)</th>
<td>ghc: panic! (the 'impossible' happened)  translateConPatVec: lookup</td></tr>
<tr><th>[\#13517](https://gitlab.staging.haskell.org/ghc/ghc/issues/13517)</th>
<td>No warnings produced, yet the pattern matching fails at runtime.</td></tr>
<tr><th>[\#14098](https://gitlab.staging.haskell.org/ghc/ghc/issues/14098)</th>
<td>Incorrect pattern match warning on nested GADTs</td></tr>
<tr><th>[\#14546](https://gitlab.staging.haskell.org/ghc/ghc/issues/14546)</th>
...
<tr><th>[\#15450](https://gitlab.staging.haskell.org/ghc/ghc/issues/15450)</th>
<td>Inconsistency w.r.t. coverage checking warnings for EmptyCase under unsatisfiable constraints</td></tr>
<tr><th>[\#15584](https://gitlab.staging.haskell.org/ghc/ghc/issues/15584)</th>
<td>nonVoid is too conservative w.r.t. strict argument types</td></tr>
<tr><th>[\#15884](https://gitlab.staging.haskell.org/ghc/ghc/issues/15884)</th>
...
by GADT matches when reporting warnings. This is illustrated in the following example ([\#3927](https://gitlab.staging.haskell.org/ghc/ghc/issues/3927)):
