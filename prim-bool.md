...
(Note: `orI#` is a bitwise OR operation on operands of type `Int#`. It was introduced together with `andI#`, `notI#` and `xor#` in [\#7689](https://gitlab.staging.haskell.org/ghc/ghc/issues/7689)). Using the LLVM backend this compiles to:
