...
1. Merge the grammar of types and kinds. This is a simplification (with a sizable [caveat](dependent-haskell#)) of the current scenario and will fix the original motivation for [\#8706](https://gitlab.staging.haskell.org/ghc/ghc/issues/8706).
...
The implementation of this is under way, [
here](https://github.com/goldfirere/ghc/tree/nokinds). More notes will be added to this section in due course.
