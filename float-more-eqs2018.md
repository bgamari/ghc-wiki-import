...
Note that `co_a1bZ` and `co_a1c0` never "interacted" as `EQSAME` suggests they should. However, they both rewrote the wanted. (In fact, it's unflattening that seems to do this, even though there are no type families involved! See [
