...
- The `InfixE` constructor of `Syntax.Exp` should only allow a `Var` in the operator position.  See Trac [\#4877](https://gitlab.staging.haskell.org/ghc/ghc/issues/4877)
