...
- [GHC 7.8.4](status/gh-c-7.8.4).  Whether or not we make this patch-level release at all, and when, depends on our users.
...
- **New** A new page which graphs our [
  ticket statistics](https://ghc.haskell.org/trac/ghc/ticketstats)
- 
...
core libraries](http://www.haskell.org/haskellwiki/Library_submissions#The_Core_Libraries). These tickets have "Component" set to "Core Libraries":
