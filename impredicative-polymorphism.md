...
<table><tr><th>[\#4347](https://gitlab.staging.haskell.org/ghc/ghc/issues/4347)</th>
<td>Bug in unification of polymorphic and not-yet-polymorphic type</td></tr>
<tr><th>[\#7264](https://gitlab.staging.haskell.org/ghc/ghc/issues/7264)</th>
<td>Adding GHC's inferred type signatures to a working program can make it fail with Rank2Types</td></tr>
<tr><th>[\#9420](https://gitlab.staging.haskell.org/ghc/ghc/issues/9420)</th>
<td>Impredicative type instantiation without -XImpredicativeTypes</td></tr>
<tr><th>[\#10619](https://gitlab.staging.haskell.org/ghc/ghc/issues/10619)</th>
<td>Order matters when type-checking</td></tr>
<tr><th>[\#11319](https://gitlab.staging.haskell.org/ghc/ghc/issues/11319)</th>
...
<tr><th>[\#12557](https://gitlab.staging.haskell.org/ghc/ghc/issues/12557)</th>
...
<tr><th>[\#14160](https://gitlab.staging.haskell.org/ghc/ghc/issues/14160)</th>
<td>Type inference breaking change in GHC 8.0.2</td></tr>
<tr><th>[\#15628](https://gitlab.staging.haskell.org/ghc/ghc/issues/15628)</th>
