...
It has recently been highlighted that as these changes affect the Prelude, and thus affect what users of Haskell see out of the box, they should be held to a higher bar than the usual libraries@ traffic. In particular, there was concern that while the [[https://wiki.haskell.org/Functor-Applicative-Monad_Proposal|Applicative/Monad Proposal (AMP)]] was warned about extensively in GHC 7.8, the [[https://wiki.haskell.org/Foldable_Traversable_In_Prelude|Foldable/Traversable Proposal]] was not nearly as well broadcast.
...
The details of the current implementation of the Foldable/Traversable proposal are available on the [[https://wiki.haskell.org/Foldable_Traversable_In_Prelude|Foldable/Traversable in Prelude]] page on the haskell.org wiki. 
