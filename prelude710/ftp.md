...
-  `Traversable` in particular has given us insight into the nature of finitary traversals and have been the subject of many papers since Jeremy Gibbons wrote [
  ...
  Investigation of the Laws of Traversals"](http://arxiv.org/pdf/1202.2919v1.pdf|"An) is one such paper, providing the common sense reading of the `Traversable` laws.
...
The details of the current implementation of the Foldable/Traversable proposal are available on the [
Foldable/Traversable in Prelude](https://wiki.haskell.org/Foldable_Traversable_In_Prelude) page on the haskell.org wiki. 
...
At least two books already teach the `Foldable` and `Traversable` abstractions: [
Learn You a Haskell](http://learnyouahaskell.com/functors-applicative-functors-and-monoids) and "Beginning Haskell".
