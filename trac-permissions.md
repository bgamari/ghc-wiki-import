...
AccountManagerPlugin](http://trac-hacks.org/wiki/AccountManagerPlugin), create a new admin account graphically and then remove the TRAC\_ADMIN permission from the anonymous user.
...
<th> View the [roadmap](trac-roadmap) page, is not (yet) the same as MILESTONE\_VIEW, see [
\#4292](http://trac.edgewall.org/intertrac/%234292) 
</th></tr>
<tr><th> `ROADMAP_ADMIN` </th>
<th> to be removed with [
\#3022](http://trac.edgewall.org/intertrac/%233022), replaced by MILESTONE\_ADMIN 
</th></tr></table>
...
<tr><th> `EMAIL_VIEW` </th>
<th> Shows email addresses even if [trac show\_email\_addresses](trac-ini#) configuration option is false 
</th></tr></table>
