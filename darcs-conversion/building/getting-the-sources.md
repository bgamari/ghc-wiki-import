...
There are two ways to get sources to GHC: get the sources directly from our repository using [http://darcs.net/ darcs] and [http://git.or.cz/ git] (reccomended) or download a source distribution.
