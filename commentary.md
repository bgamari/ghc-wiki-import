...
Try to link to source files as much as possible by using this macro: {{{[[GhcFile(compiler/Makefile)]]}}}. Also try to add appropriate [http://www.fixithere.net/sky-contact-number/ links] to other parts of the commentary.
