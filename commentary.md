...
- General Notes on the GHC compiler
  ...
  - Ningning Xie's \[literature review\|[
    https://github.com/xnning/GHC-Core-Literature-Review/blob/master/doc/doc.pdf](https://github.com/xnning/GHC-Core-Literature-Review/blob/master/doc/doc.pdf)\] of various contributions to GHC's type system 
...
- Notes on implemented GHC features:
  ...
  - [
    Evaluation order and state tokens](https://www.fpcomplete.com/tutorial-preview/4431/z0KpB0ai2R): notes written by Michael Snoyberg in response to [\#9390](https://gitlab.staging.haskell.org/ghc/ghc/issues/9390).
...
- Notes on proposed or in progress (but out of tree) GHC compiler features:
  ...
  - [StaticValues](static-values) and ticket [\#7015](https://gitlab.staging.haskell.org/ghc/ghc/issues/7015)
  - [Partial type signatures](partial-type-signatures) and its ticket [\#9478](https://gitlab.staging.haskell.org/ghc/ghc/issues/9478)
  - [Late lambda-lifting](late-lam-lift), and its ticket [\#9476](https://gitlab.staging.haskell.org/ghc/ghc/issues/9476)
