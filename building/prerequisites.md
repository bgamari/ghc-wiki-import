...
'''Note:''' currently you'll also need to install an older version of [http://www.haskell.org/haddock Haddock] (0.9) manually, because the version of Haddock you'll get by default is 2.0.0.0 which doesn't work with GHC's build system yet.
...
See also [wiki:Building/Windows].
