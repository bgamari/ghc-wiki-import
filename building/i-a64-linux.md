...
As a solution, nice Gentoo Linux folks provide their own set of patches for IA64 GHC build and you can use them to compile GHC 6.12.3 on IA64 platform. Download and apply all __ghc-6.12.3-ia64*patch__ patches from: http://sources.gentoo.org/cgi-bin/viewvc.cgi/gentoo-x86/dev-lang/ghc/files/
