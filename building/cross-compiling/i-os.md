...
(requires [
https://ghc.haskell.org/trac/ghc/ticket/8700](https://ghc.haskell.org/trac/ghc/ticket/8700))
...
Check out the latest version of Cabal from [
...
- Template Haskell for cross compilers! Could be done by (in order of increasing complexity):
  ...
  - Evil Splicer [
    https://github.com/joeyh/git-annex/blob/master/Build/EvilSplicer.hs](https://github.com/joeyh/git-annex/blob/master/Build/EvilSplicer.hs) / zeroth method [
    http://hackage.haskell.org/package/zeroth](http://hackage.haskell.org/package/zeroth)
