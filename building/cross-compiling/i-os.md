...
If you use ghc-7.6.3 on OS X as your bootstrap compiler and you are using Xcode version 5 or higher, you'll need to pass certain options to clang to work around some problems. A wrapper for this, written in Haskell, can be found at [
...
You'll also need to apply [\#8445](https://gitlab.staging.haskell.org/ghc/ghc/issues/8445) and [\#8444](https://gitlab.staging.haskell.org/ghc/ghc/issues/8444) until they're merged.
