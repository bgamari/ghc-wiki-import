...
### 0. Acquire Xcode 4.6.3



We haven't quite finished updating GHC-iOS for Xcode 5 yet, so you'll need version 4.6.3. It contains gcc-based ARM/i386 compilers that were removed in version 5.



Happily, it will live politely next to Xcode 5 if you give it a different name. You can get it easily from Apple here:
[
https://developer.apple.com/downloads/index.action?name=Xcode\#](https://developer.apple.com/downloads/index.action?name=Xcode#)



You'll have to update the scripts in step 2 to point to the location that you copy the Xcode 4.6.3 app to.
