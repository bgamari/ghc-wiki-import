...
Some recent changes are needed for the cross-compiling stuff to work right. Type `cabal --version` to find out what you have. Cabal-1.17.0 is new enough.



The easiest way to install the right version is to do this inside your ghc build directory:
...
### 9. Set up your Xcode project for Haskell
