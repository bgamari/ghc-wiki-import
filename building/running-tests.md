...
1. Having found a suitable place for the test, give the test a name.
  ...
  test: for example, in typecheck/should\_compile, tests are named
...
> > >
> > >
> > > **skip\_if\_tag(tag)**      skip if the compiler has a given tag
> > >
> > >
> >
>
...
> > >
> > >
> > > **skip\_unless\_tag(tag)**  skip unless the compiler has a given tag
> > >
> > >
> >
>
...
> > > > changed in the same way as for compile\_and\_run.
> > > >
> > > >
> > >
> >
...
> >
> >
> > For compile, compile\_fail and compile\_and\_run, \<args\>
...
> >
> >
> > The multimod\_ versions of compile and compile\_and\_run
