...
The `--disable-large-address-space` disables the runtime's two-step allocator, which isn't currently supported on FreeBSD (see [\#12695](https://gitlab.staging.haskell.org/ghc/ghc/issues/12695)).
