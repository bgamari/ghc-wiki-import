...
64-bit (x86-64) MSYS2 installer](https://sourceforge.net/projects/msys2/files/Base/x86_64/) or [
32-bit (i686) MSYS2 installer](http://sourceforge.net/projects/msys2/files/Base/i686/). Be sure to open a mingw64 or mingw32 shell (see below).
...
introduction to MSYS2](https://sourceforge.net/p/msys2/wiki/MSYS2%20introduction/).
...
then try running the previous command with the `--force` option (see [
