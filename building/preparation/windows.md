...
```wiki
pacman -Sy git tar binutils autoconf make libtool automake p7zip
```
...
(Note: the 'alex' build appears to be broken on the 32-bit platform, see [\#9712](https://gitlab.staging.haskell.org/ghc/ghc/issues/9712).)
