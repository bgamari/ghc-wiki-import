...
Note that this currently needs to be done after installation. See [\#2933](https://gitlab.staging.haskell.org/ghc/ghc/issues/2933) about integrating it into the build process.
