...
<table><tr><th>[
config.mk.in](http://darcs.haskell.org/ghc/mk/config.mk.in)</th>
<td>
...
<table><tr><th>[
compiler/ghc.mk](http://darcs.haskell.org/ghc/compiler/ghc.mk), [
rts/ghc.mk](http://darcs.haskell.org/ghc/rts/ghc.mk), etc.</th>
<td>
...
project.mk.in](http://darcs.haskell.org/mk/project.mk.in), defines several symbols related to the platform settings.
