...
- Go to [
  http://www.mingw.org/download.shtml](http://www.mingw.org/download.shtml) and 
...
- The clever way is to point the Cygwin installer at the
  ...
  the
  offered mirror sites; and then type "[
  http://haskell.org/ghc/cygwin](http://haskell.org/ghc/cygwin)" into the
...
- Install an executable GHC, from [
...
- Install an executable Happy, from [
  http://www.haskell.org/happy](http://www.haskell.org/happy).
- Install an executable Alex, froim [
...
- Finally, check out a copy of GHC sources from
  ...
  http://hackage.haskell.org/trac/ghc/wiki/GhcDarcs](http://hackage.haskell.org/trac/ghc/wiki/GhcDarcs).
