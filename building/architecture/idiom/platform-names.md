...
file, which is generated by `configure` from [http://darcs.haskell.org/ghc/mk/project.mk.in project.mk.in], defines several symbols related to the platform settings.
...
the comments in [http://darcs.haskell.org/ghc/mk/project.mk.in project.mk.in].
```
