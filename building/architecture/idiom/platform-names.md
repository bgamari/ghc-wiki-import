...
file, which is generated by `configure` from [mk/project.mk.in](/trac/ghc/browser/ghc/mk/project.mk.in), defines several symbols related to the platform settings.
...
the comments in [mk/project.mk.in](/trac/ghc/browser/ghc/mk/project.mk.in).
