...
A GHC tree consists of [wiki:Repositories multiple repositories]. The `sync-all` Perl script lets you operate over them all at once.

The basic interface to `sync-all` is described in comments at the top of the [http://darcs.haskell.org/ghc/sync-all source file].
