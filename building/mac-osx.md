...
register](https://developer.apple.com/programs/register/) as an Apple developer first. (This is a free registration.)
...
**NB:** You need to use a binary distribution of GHC 7.4.1 (or later) as a bootstrap compiler. (Earlier versions fail with an error message complaining about the lack of `/Developer/usr/bin/gcc`. You can fix this by editing the GHC wrapper script if you prefer tp use an older compiler.)
