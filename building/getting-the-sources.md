...
{{{#!box note
The commands given below are slightly outdated. Since [db19c665ec5055c2193b2174519866045aeff09a/ghc] converted all sub-repos into submodules, you can simply clone a specific branch via:
