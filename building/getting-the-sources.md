...
Now, to create a new workdir, run `git new-workdir ghc-pristine ghc-newdir`, and then inside `ghc-newdir`, run `` to recursively make workdirs of all the submodules.
