...
Note 2: The `--testsuite` option is gone ([\#8545](https://gitlab.staging.haskell.org/ghc/ghc/issues/8545)).
...
Put it in a file, and run `./utils/fingerprint.py restore -f <file>` to restore your repository tree to that state. Another resource you can use to find fingerprints is [
ghc-complete](https://github.com/nomeata/ghc-complete), although coverage here only began in late 2013.
