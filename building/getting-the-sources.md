...
See the [wiki:Building building guide], notably [wiki:Building/Preparation], for how to proceed after this.
...
'''Note:''' The following directions are valid for cloning GHC 7.9 or newer. For cloning GHC 7.8 or earlier, see the [wiki:Building/GettingTheSources/Legacy legacy] instructions.
