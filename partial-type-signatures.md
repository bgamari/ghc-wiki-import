...
> is not *that* common (see [
> Section 4.3.1](http://research.microsoft.com/apps/pubs/default.aspx?id=162516) of
...
1. There are two actual TODOs in the code:
  ...
  1. TODO In the local function `makeWanted` in `tcPolyInfer`, in `TcBinds.lhs`,
