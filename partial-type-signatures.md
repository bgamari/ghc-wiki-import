...
6. There are two actual TODOs (I use TODOT to know it's one of my TODOs) in the code:
   [[br]][[br]]
    ...
    2. TODO In the `PatBind` case of `TcLhs` in `TcBinds.lhs`, no wildcard constraints are emitted.
