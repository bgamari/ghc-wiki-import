...
* We have not yet taken care to correctly handle [#local-definitions local definitions].
...
* One of the examples described in the [#mr section] about the monomorphism
...
* There are two actual TODOs in the code:
  [[br]][[br]]
   ...
   2. In the local function `makeWanted` in `tcPolyInfer`, in `TcBinds.lhs`,
