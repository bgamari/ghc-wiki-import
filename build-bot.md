...
In order to actually do the build, you'll also need the prerequisite tools for a GHC build, see [wiki:Building/Prerequisites], and you should have darcs installed too (we recommend at least version 0.9).
