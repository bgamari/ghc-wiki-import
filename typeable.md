...
<table><tr><th>[\#3480](https://gitlab.staging.haskell.org/ghc/ghc/issues/3480)</th>
<td>Easily make Typeable keys pure, so that Typeable can be handled efficiently across communications</td></tr>
<tr><th>[\#8931](https://gitlab.staging.haskell.org/ghc/ghc/issues/8931)</th>
<td>The type defaulting in GHCi with Typeable</td></tr>
<tr><th>[\#9639](https://gitlab.staging.haskell.org/ghc/ghc/issues/9639)</th>
<td>Remove OldTypeable</td></tr>
<tr><th>[\#9707](https://gitlab.staging.haskell.org/ghc/ghc/issues/9707)</th>
<td>(Try to) restructure \`base\` to allow more use of \`AutoDeriveTypeable\`</td></tr>
<tr><th>[\#10163](https://gitlab.staging.haskell.org/ghc/ghc/issues/10163)</th>
<td>Export typeRepKinds in Data.Typeable</td></tr>
<tr><th>[\#10343](https://gitlab.staging.haskell.org/ghc/ghc/issues/10343)</th>
<td>Make Typeable track kind information better</td></tr>
<tr><th>[\#11011](https://gitlab.staging.haskell.org/ghc/ghc/issues/11011)</th>
<td>Add type-indexed type representations (\`TypeRep a\`)</td></tr>
<tr><th>[\#11120](https://gitlab.staging.haskell.org/ghc/ghc/issues/11120)</th>
...
<tr><th>[\#11722](https://gitlab.staging.haskell.org/ghc/ghc/issues/11722)</th>
...
<tr><th>[\#12082](https://gitlab.staging.haskell.org/ghc/ghc/issues/12082)</th>
<td>Typeable on RealWorld fails</td></tr>
<tr><th>[\#12123](https://gitlab.staging.haskell.org/ghc/ghc/issues/12123)</th>
<td>GHC crashes when calling typeRep on a promoted tuple</td></tr>
<tr><th>[\#12409](https://gitlab.staging.haskell.org/ghc/ghc/issues/12409)</th>
...
<tr><th>[\#13197](https://gitlab.staging.haskell.org/ghc/ghc/issues/13197)</th>
...
<tr><th>[\#14199](https://gitlab.staging.haskell.org/ghc/ghc/issues/14199)</th>
<td>Document Type.Reflection better (Fun and Con')</td></tr>
<tr><th>[\#14254](https://gitlab.staging.haskell.org/ghc/ghc/issues/14254)</th>
<td>The Binary instance for TypeRep smells a bit expensive</td></tr>
<tr><th>[\#14925](https://gitlab.staging.haskell.org/ghc/ghc/issues/14925)</th>
<td>Non-ASCII type names get garbled when their \`TypeRep\` is shown</td></tr>
<tr><th>[\#15067](https://gitlab.staging.haskell.org/ghc/ghc/issues/15067)</th>
...
in the API. I (Richard) conjecture that this is all possible without kind equalities, but would be rather awkward due to GHC's insistence that kind parameters be implicit. See [\#10343](https://gitlab.staging.haskell.org/ghc/ghc/issues/10343), which inspired this bit.
...
**Iceland\_jack**: I recall a conversation about making `:~:` a pattern synonym for `:~~:`
...
As painfully demonstrated (painful in the conclusion, not the demonstration!) in [comment:16:ticket:9858](https://gitlab.staging.haskell.org/ghc/ghc/issues/9858), `Typeable` can now (7.10.1 RC1) be abused to write `unsafeCoerce`. The problem is that today's `TypeRep`s ignore kind parameters.
...
[comment:16:ticket:9858](https://gitlab.staging.haskell.org/ghc/ghc/issues/9858) is a demonstration that the boat is taking on water! Fix the leak, fast!
