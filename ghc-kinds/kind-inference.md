...
This page summarises several alternative designs, which are debated on [\#9200](https://gitlab.staging.haskell.org/ghc/ghc/issues/9200).  (See also [\#9201](https://gitlab.staging.haskell.org/ghc/ghc/issues/9201).)
...
This strategy allows polymorphic recursion in classes while remaining simpler than (PARGEN). See [comment:19:ticket:9200](https://gitlab.staging.haskell.org/ghc/ghc/issues/9200) for more exposition.
