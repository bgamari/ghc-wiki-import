...
One of the major factors that has changed recently is `integer-gmp`. Namely, GHC 7.10 includes `integer-gmp-1.0`, a major rework of `integer-gmp-0.5`. I've compiled GHC 7.10.1 with `integer-gmp` 0.5 and 1.0. [Here https://gist.github.com/bgamari/5de75ac998a346b70ce8] is a nofib comparison. There are a few interesting points here,
