...
- To orient yourself to the general architecture of GHC, [
  this article](http://www.aosabook.org/en/ghc.html) ([
  PDF version](http://community.haskell.org/~simonmar/papers/aos.pdf‎)), written by two of the chief architects of GHC, Simon Marlow and Simon Peyton-Jones, is excellent and current (2012).
...
- [\#7021](https://gitlab.staging.haskell.org/ghc/ghc/issues/7021)
- [\#7401](https://gitlab.staging.haskell.org/ghc/ghc/issues/7401)
- [\#7901](https://gitlab.staging.haskell.org/ghc/ghc/issues/7901)
- [\#8100](https://gitlab.staging.haskell.org/ghc/ghc/issues/8100)
