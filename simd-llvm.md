...
Related pages
 * [wiki:SIMDPlan Implementation plan]
 * There is also also the outdated [wiki:VectorComputing].
...
For implementation details and a plan, refer to the [wiki:SIMDPlan SIMD Implementation Details and Plan] Page
```
