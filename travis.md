...
Travis is not 100% reliable for us, as we occasionally hit the time limit. Therefore, mails about failing reports are sent to Joachim and the [[MailingListsAndIRC|ghc-builds]] mailing lists. Joachim will report true positives to `ghc-dev` or the commiter directly.
