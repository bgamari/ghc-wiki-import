...
- [\#9851](https://gitlab.staging.haskell.org/ghc/ghc/issues/9851) - Hoopl library in GHC hides runWithFuel / version number clash
- [\#9853](https://gitlab.staging.haskell.org/ghc/ghc/issues/9853) - Stateful transformation causes non-termination in Hoopl analysis.
- [\#8315](https://gitlab.staging.haskell.org/ghc/ghc/issues/8315) - Improve specialized Hoopl module
