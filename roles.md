...
<table><tr><th>[\#9112](https://gitlab.staging.haskell.org/ghc/ghc/issues/9112)</th>
...
<table><tr><th>[\#8246](https://gitlab.staging.haskell.org/ghc/ghc/issues/8246)</th>
<td>Role annotations does not allow the use of parenthesis</td></tr>
<tr><th>[\#9117](https://gitlab.staging.haskell.org/ghc/ghc/issues/9117)</th>
...
<tr><th>[\#9131](https://gitlab.staging.haskell.org/ghc/ghc/issues/9131)</th>
<td>Experiment with a dedicated solver for Coercible</td></tr>
<tr><th>[\#10905](https://gitlab.staging.haskell.org/ghc/ghc/issues/10905)</th>
<td>Incorrect number of parameters in "role" errors</td></tr>
<tr><th>[\#11230](https://gitlab.staging.haskell.org/ghc/ghc/issues/11230)</th>
...
<tr><th>[\#14101](https://gitlab.staging.haskell.org/ghc/ghc/issues/14101)</th>
...
<tr><th>[\#14363](https://gitlab.staging.haskell.org/ghc/ghc/issues/14363)</th>
<td>:type hangs on coerce</td></tr>
<tr><th>[\#15294](https://gitlab.staging.haskell.org/ghc/ghc/issues/15294)</th>
<td>Unused "foralls" prevent types from being Coercible</td></tr>
<tr><th>[\#15431](https://gitlab.staging.haskell.org/ghc/ghc/issues/15431)</th>
...
This example ([
courtesy of glguy](https://ghc.haskell.org/trac/ghc/ticket/8177#comment:32)) will not typecheck:
...
Another example ([
courtesy of int-index](https://ghc.haskell.org/trac/ghc/ticket/8177#comment:33)) is:
...
Additionally, we might like to have roles for *associated* type families. For instance, consider this example ([
courtesy of dmcclean](https://ghc.haskell.org/trac/ghc/ticket/8177#comment:20)):
...
Next, we descend into each defining equation of the type family and inspect the left-hand and right-hand sides. The right-hand sides are analyzed just like the fields of a data constructor; see the [
Role inference](https://ghc.haskell.org/trac/ghc/wiki/Roles#Roleinference) section above for more details. From the right-hand sides, we learn that the roles of `e`, `f`, and `g` should be (at least) `representational`.
