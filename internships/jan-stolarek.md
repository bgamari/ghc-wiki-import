...
- improve Cmm dumping. I think that during pretty-printing of Cmm labels of the entry code of a closure are refered to as "info\_table", while the label of the whole closure is refered to as "entry". This is confusing.
