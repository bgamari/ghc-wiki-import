...
get a `IV` instance.  Similar things happen today with [
ordinary records selectors for existentials.](https://downloads.haskell.org/~ghc/latest/docs/html/users_guide/data-type-extensions.html#existential-records)
