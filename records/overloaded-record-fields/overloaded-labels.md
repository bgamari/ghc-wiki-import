...
This page describes the `OverloadedLabels` extension, part 2 of the [OverloadedRecordFields proposal](records/overloaded-record-fields). This is currently being reviewed at [
Phab:D1331](https://phabricator.haskell.org/D1331), and **should be in GHC 8.0.**
...
*Adam*: I tend to agree, and I've brought this up on [
