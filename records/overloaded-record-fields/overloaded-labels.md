...
This page describes the `OverloadedLabels` extension, part 2 of the [OverloadedRecordFields proposal](records/overloaded-record-fields). This was implemented as [
Phab:D1331](https://phabricator.haskell.org/D1331), and **will be in GHC 8.0.**
