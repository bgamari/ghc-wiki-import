...
Annoyingly, the generated code for `setField` doesn't typecheck for GADTs, because of [\#2595](https://gitlab.staging.haskell.org/ghc/ghc/issues/2595). At the moment, it generates
...
I wonder if it would be easier to fix [\#2595](https://gitlab.staging.haskell.org/ghc/ghc/issues/2595).
