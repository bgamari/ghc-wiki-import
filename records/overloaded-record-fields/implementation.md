 ...
 * See [http://www.well-typed.com/blog/107/ Adam's blog post]
...
As of March 2015, work is progressing on the implementation. Part 1 (the simplified `OverloadedRecordFields` extension) is available at Phab:D761 to be reviewed and merged. Parts 2 and 3 will then be implemented. Note that all the parts are useful in isolation.
