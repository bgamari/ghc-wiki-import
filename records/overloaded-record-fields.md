...
idea (summarised under "Nonextensible records with polymorphic selection & update" on at [wiki:Records])there are numerous ramifications.  Records are a swamp!
...
This proposal is quite closely related to the [wiki:TypeDirectedNameResolution Type Directed Name Resolution] idea, becuase TDNR 
