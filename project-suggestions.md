...
== Projects that should be within reach of a good undergraduate ==
  ...
  * '''Implement overlap and exhaustiveness checking for pattern matching'''.  GHC's current overlap and exhaustiveness checker is old and inadequate.  Furthermore, it takes no account of GADTs and type families. See #595.  There's an excellent selection of background material:
 ...
 * [[TicketQuery(id=2362|0)]]
 * [[TicketQuery(id=2979|0)]]
 * [[TicketQuery(id=594|0)]]
