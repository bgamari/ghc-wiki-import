 ...
 * We also use dedicated [[wiki:BuilderSummary|build bots]] to regularly [[http://haskell.inf.elte.hu/builders/|build GHC]] and the [[http://haskell.inf.elte.hu/docs/|user documentation]]
 * We can quickly install different versions of GHC with these [[https://launchpad.net/~hvr/+archive/ubuntu/ghc|Ubuntu packages]].
