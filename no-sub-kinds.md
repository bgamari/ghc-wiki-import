...
- Proposed criterion: **`(ty:TYPE l)` cannot occur on the left of an arrow, or in the type of a binder of a let**.  And hence not as a field of a constructor, because then the constructor's type is illegal.
