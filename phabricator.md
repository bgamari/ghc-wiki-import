...
Phab:D69](https://phabricator.haskell.org/D69) is a good example:
...
Go to the [
Herald application](https://phabricator.haskell.org/herald/) and click *Create New Herald Rule* at the top right.
...
Once you've created a Herald rule, you may now go to the Go to the [
...
Alternatively, you may use Diffusion to [
...
Herald user guide](https://secure.phabricator.com/book/phabricator/article/herald/), as well as the [
Audit user guide](https://secure.phabricator.com/book/phabricator/article/audit/). There's also some documentation on [
review vs audit workflows](https://secure.phabricator.com/book/phabricator/article/reviews_vs_audit/) in the Phab documentation.
...
When you login, by default you'll be greeted
...
- There's a convenient [
  PasteBin application](https://phabricator.haskell.org/paste/) which you can use to paste and share snippets - you can even do this directly from Arcanist.
- [
...
- If you're paranoid, you can enable [
