...
GHC is the result of many peoples hard work, and this page gives detail on exactly who is responsible for what in precise detail. For a more general overview of the responsibilities people take, see [wiki:CodeOwners the Code Owners] page.
 ...
 * Gabor Greif
  * N/A - ???
  * '''Trac''': heisenbug; '''email''': ggreif@gmail.com
  * '''Committer since''': August, 2013.
  * '''Main areas of interest''': ...
 ...
 * Jan Stolarek
  ...
  * '''Trac''': jstolarek; '''email''': jan.stolarek@p.lodz.pl
  * '''Committer since''': August, 2013.
 ...
 * Max Bolingbroke
  * N/A - Cambridge, UK
  * '''Trac''': batterseapower; '''email''': batterseapower@hotmail.com
  * '''Committer since''': August, 2013.
 ...
 * Simon Hengel
  * N/A - Berlin, Germany
  * '''Trac''': !SimonHengel; '''email''': sol@typeful.net
  * '''Committer since''': August, 2013.
  * '''Main areas of interest''': haddock
 ...
 * Thomas Schilling
  ...
  * '''Trac''': nominolo; '''email''': nominolo@googlemail.com
  * '''Committer since''': August, 2013.
...
[mailto:lennart@augustsson.net Lennart Augustsson] (including work on many core libraries, originally for hbc),
...
[http://catamorphism.org/ Tim Chevalier] (External Core, strictness analysis, ticky-ticky profiling),
[mailto:duncan.coutts@well-typed.com Duncan Coutts] (parallel profiling, package system),
[http://www.purely-functional.net Iavor S Diatchki] (type-level literals),
[http://www.cis.upenn.edu/~eir Richard Eisenberg],
[mailto:sof@galois.com Sigbjorn Finne],
[mailto:andygill@ku.edu Andy Gill] (Haskell Program Coverage),
Kevin Glynn,
...
[mailto:hwloidl@tcs.ifi.lmu.de Hans Wolfgang Loidl],
John Launchbury,
...
[mailto:audreyt@audreyt.org Audrey Tang] (Perl-related tools (ghc-asm, ghc-split), AIX port),
