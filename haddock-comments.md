...
Google Summer Of Code](http://code.google.com/soc) project aiming to port the existing Haddock program to use the GHC API. Thus, GHC understands Haddock comments and they are available through the GHC API.



Due to the SoC initiative GHC can understand Haddock comments
...
1. The concrete types of the subterms, if they are sufficiently evaluated.
