...
Module headers, every type of doc comment, option and so on that is supported by the original Haddock can also be recognized by GHC and retrieved from the GHC API.  
