...
1. The `Coercible` solver is getting somewhat involved already ([\#9117](https://gitlab.staging.haskell.org/ghc/ghc/issues/9117), [\#9131](https://gitlab.staging.haskell.org/ghc/ghc/issues/9131))
