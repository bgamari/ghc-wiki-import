...
The Master List of repositories is in the file [http://darcs.haskell.org/ghc/packages $(TOP)/packages].  It is authoritative.  Everything else in this sub-section may be out of date, although it gives the right general idea.
...
||http://darcs.haskell.org/packages/array.git||
||http://darcs.haskell.org/packages/base.git||
||http://darcs.haskell.org/packages/bytestring.git||
||http://darcs.haskell.org/packages/Cabal.git||
||http://darcs.haskell.org/packages/containers.git||
||http://darcs.haskell.org/packages/directory.git||
||http://darcs.haskell.org/packages/filepath.git||
||http://darcs.haskell.org/packages/haskell98.git||
||http://darcs.haskell.org/packages/old-locale.git||
||http://darcs.haskell.org/packages/old-time.git||
||http://darcs.haskell.org/packages/packedstring.git||
||http://darcs.haskell.org/packages/pretty.git||
||http://darcs.haskell.org/packages/process.git||
||http://darcs.haskell.org/packages/random.git||
||http://darcs.haskell.org/packages/readline.git||
||http://darcs.haskell.org/packages/template-haskell.git||
||http://darcs.haskell.org/packages/unix.git||
||http://darcs.haskell.org/packages/Win32.git||
||http://darcs.haskell.org/packages/hpc.git||
