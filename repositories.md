...
GHC's repos use Git; see [wiki:WorkingConventions/Git].  For Darcs-related stuff see also [wiki:DarcsToGit] and [wiki:GitForDarcsUsers].  Simon PJ's git notes are [wiki:WorkingConventions/GitSPJ].
