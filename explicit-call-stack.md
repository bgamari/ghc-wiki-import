...
- [\#1441](https://gitlab.staging.haskell.org/ghc/ghc/issues/1441), which would be fixed by this.
- [
...
The debugger can be extended to recognize bindings carrying this explicit stack and provide call stack traces in vanilla breakpoints. It would be possible then to fire the debugger in head\_check by simply:
