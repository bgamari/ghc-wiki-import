...
See also
  * [http://http://research.microsoft.com/~simonpj/papers/stack-trace/DebugTraces.pdf Finding the needle], a paper describing Tristan Allwood's intern project to implement explicit call stacks in GHC.
  * #1441, #960, which would be fixed by this.
