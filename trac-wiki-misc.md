...
[/trac/ghc/login log in] as user '''guest''' with password '''guest'''.

When writing Wiki pages you need to know the markup conventions:
  * The [wiki:TracGuide Help/Guide link] at the top of  every page gives a good description of the markup language etc.  From there you can get to the [wiki:WikiFormatting main guide to the Trac Wiki formatting].  
