 ...
 * Use runtime debugging options to help narrow down the fault (see also the [http://www.haskell.org/ghc/docs/latest/html/users_guide/runtime-control.html#rts-options-debugging  relevant User Manual section]).
...
[http://darcs.haskell.org/ghc/compiler/utils/Encoding.hs Encoding.hs]).  Basically special symbols are replaced by sequences
...
(see [http://darcs.haskell.org/ghc/compiler/cmm/CLabel.hs CLabel.hs]
...
display 4 words of memory, or using our [attachment:".gdbinit" gdb macros] you get slighty
nicer output:
...
[http://darcs.haskell.org/ghc/includes/stg/MachRegs.h MachRegs.h] to
...
[http://darcs.haskell.org/ghc/includes/rts/storage/Closures.h Closures.h].
...
[http://darcs.haskell.org/ghc/includes/rts/storage/InfoTables.h InfoTables.h].
...
[http://darcs.haskell.org/ghc/includes/rts/storage/ClosureTypes.h ClosureTypes.h]
