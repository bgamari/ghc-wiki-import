...
Here's how to submit a bug fix to GHC. For [wiki:WorkingConventions/AddingFeatures adding features], there are a few extra steps to follow.
 ...
 0. '''Submit one or several code reviews''' to [wiki:Phabricator]. Wait for [wiki:Phabricator/Harbormaster] to build and validate your commits (~35 minutes each, September 2014).[[BR]][[BR]]
 ...
 0. '''Wait''' for the reviewers to look at your patches. If this takes more than a week, complain!
