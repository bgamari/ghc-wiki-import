...
If git doesn't know that `origin/experiment` is a branch, the above `git checkout` command interprets `origin/experiment` as a file name, and outputs the strange message
{{{
