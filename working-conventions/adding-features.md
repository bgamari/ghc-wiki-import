...
We welcome your involvement in making GHC able to do more. Here's how to do it.
 ...
 0. Write down the '''specification''' of the feature and create a Wiki page for it.  Specifying before implementing is obviously a good idea; and it makes it possible for others to comment on your design before you invest heavily in building the feature.  [[BR]][[BR]]
 ...
 0. Include updates to the '''user manual''' that documents your feature (`docs/users_guide/*`).  [[BR]][[BR]]
 0. Add a section to the latest '''release notes''' (`docs/users_guide/7.12.1-notes.xml`).  [[BR]][[BR]]
 0. Follow the instructions for '''[wiki:WorkingConventions/FixingBugs contributing a patch]'''.
