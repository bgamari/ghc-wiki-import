...
This page describes how to use Git for [wiki:WorkingConventions/FixingBugs contributing patches to GHC] and extends upon the
instructions provided in [wiki:Building/GettingTheSources getting the sources].

== Working in a single git tree ==

=== Submodules ===
See [wiki:/WorkingConventions/Git/Submodules git submodules] when making changes to other repositories in a GHC tree.
...
=== Tips ===
The [wiki:WorkingConventions/Git/Tricks Git Tricks] page describes some non-GHC specific suggestions and tips for using Git.
