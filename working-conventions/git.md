...
> GitHub's issue close syntax](https://help.github.com/articles/closing-issues-via-commit-messages))
>
>
...
>
>
> This will close [\#10](https://gitlab.staging.haskell.org/ghc/ghc/issues/10) and [\#12](https://gitlab.staging.haskell.org/ghc/ghc/issues/12), and add a comment to [\#10](https://gitlab.staging.haskell.org/ghc/ghc/issues/10), [\#12](https://gitlab.staging.haskell.org/ghc/ghc/issues/12), and [\#13](https://gitlab.staging.haskell.org/ghc/ghc/issues/13).
>
>
