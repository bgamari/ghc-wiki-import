...
found the Ubuntu EBS-backed AMI that I used as a base.  Ubuntu [https://wiki.ubuntu.com/ServerLucidEc2EBSRoot plan to make EBS-backed images] of future releases, so this should get easier.
