...
<table><tr><th>[\#17](https://gitlab.staging.haskell.org/ghc/ghc/issues/17)</th>
<td>Separate warnings for unused local and top-level bindings</td></tr>
<tr><th>[\#667](https://gitlab.staging.haskell.org/ghc/ghc/issues/667)</th>
<td>Efficient Map \<-\> Set conversions</td></tr>
<tr><th>[\#738](https://gitlab.staging.haskell.org/ghc/ghc/issues/738)</th>
<td>ghc can't load files with selinux Enforcing</td></tr>
<tr><th>[\#907](https://gitlab.staging.haskell.org/ghc/ghc/issues/907)</th>
<td>Case sensitive ghci commands</td></tr>
<tr><th>[\#984](https://gitlab.staging.haskell.org/ghc/ghc/issues/984)</th>
<td>Syntax error shows in the wrong position</td></tr>
<tr><th>[\#1029](https://gitlab.staging.haskell.org/ghc/ghc/issues/1029)</th>
<td>ghc fails to find installed user package even though "ghc-pkg list" shows it</td></tr>
<tr><th>[\#1102](https://gitlab.staging.haskell.org/ghc/ghc/issues/1102)</th>
<td>Lambda unicode character lex</td></tr>
<tr><th>[\#1103](https://gitlab.staging.haskell.org/ghc/ghc/issues/1103)</th>
<td>Japanese Unicode</td></tr>
<tr><th>[\#1148](https://gitlab.staging.haskell.org/ghc/ghc/issues/1148)</th>
<td>Bad warnings about unused imports that are in fact needed</td></tr>
<tr><th>[\#1258](https://gitlab.staging.haskell.org/ghc/ghc/issues/1258)</th>
<td>Insecure temporary file creation</td></tr>
<tr><th>[\#1448](https://gitlab.staging.haskell.org/ghc/ghc/issues/1448)</th>
<td>Segmentation fault with readline Module</td></tr>
<tr><th>[\#1527](https://gitlab.staging.haskell.org/ghc/ghc/issues/1527)</th>
<td>parsing error message that could be improved</td></tr>
<tr><th>[\#1570](https://gitlab.staging.haskell.org/ghc/ghc/issues/1570)</th>
<td>ghc panic when compiling with -fPIC</td></tr>
<tr><th>[\#1762](https://gitlab.staging.haskell.org/ghc/ghc/issues/1762)</th>
...
<tr><th>[\#1968](https://gitlab.staging.haskell.org/ghc/ghc/issues/1968)</th>
<td>data family + GADT: not implemented yet</td></tr>
<tr><th>[\#2047](https://gitlab.staging.haskell.org/ghc/ghc/issues/2047)</th>
<td>ghc compiled program crashes with segfault when using -M and/or -c</td></tr>
<tr><th>[\#2109](https://gitlab.staging.haskell.org/ghc/ghc/issues/2109)</th>
<td>hIsEOF blocks when applied to a non-closed socket with no input available</td></tr>
<tr><th>[\#2118](https://gitlab.staging.haskell.org/ghc/ghc/issues/2118)</th>
<td>deriving for GRose</td></tr>
<tr><th>[\#2172](https://gitlab.staging.haskell.org/ghc/ghc/issues/2172)</th>
<td>ghci / ghc -e outputs terminal escapes even when redirected to file/pipe</td></tr>
<tr><th>[\#2199](https://gitlab.staging.haskell.org/ghc/ghc/issues/2199)</th>
<td>th32SnapEnumProcesses in System.Win32.Process prints debugging information to stdout</td></tr>
<tr><th>[\#2431](https://gitlab.staging.haskell.org/ghc/ghc/issues/2431)</th>
<td>Allow empty case analysis</td></tr>
<tr><th>[\#2587](https://gitlab.staging.haskell.org/ghc/ghc/issues/2587)</th>
<td>Optimiser bug with extistentials and GADT's</td></tr>
<tr><th>[\#2714](https://gitlab.staging.haskell.org/ghc/ghc/issues/2714)</th>
<td>No match in record selector Var.tcTyVarDetails</td></tr>
<tr><th>[\#2868](https://gitlab.staging.haskell.org/ghc/ghc/issues/2868)</th>
<td>\`par\` \`pseq\` does not work as expected</td></tr>
<tr><th>[\#2940](https://gitlab.staging.haskell.org/ghc/ghc/issues/2940)</th>
<td>Do CSE after CorePrep</td></tr>
<tr><th>[\#2983](https://gitlab.staging.haskell.org/ghc/ghc/issues/2983)</th>
<td>Segmentation fault in ray tracer with certain options</td></tr>
<tr><th>[\#3212](https://gitlab.staging.haskell.org/ghc/ghc/issues/3212)</th>
<td>getOptions'.parseLanguage(2) went past eof token</td></tr>
<tr><th>[\#3749](https://gitlab.staging.haskell.org/ghc/ghc/issues/3749)</th>
<td>unexpected parse errors with \`do\` and \`let\`</td></tr>
<tr><th>[\#3752](https://gitlab.staging.haskell.org/ghc/ghc/issues/3752)</th>
...
<tr><th>[\#3974](https://gitlab.staging.haskell.org/ghc/ghc/issues/3974)</th>
<td>Duplicate bug: (see \#3975) filepath: normalise trailing dot</td></tr>
<tr><th>[\#3975](https://gitlab.staging.haskell.org/ghc/ghc/issues/3975)</th>
<td>filepath: normalise trailing dot</td></tr>
<tr><th>[\#4038](https://gitlab.staging.haskell.org/ghc/ghc/issues/4038)</th>
<td>segmentation fault between GHC-6.12.2 and gtk2hs</td></tr>
<tr><th>[\#4039](https://gitlab.staging.haskell.org/ghc/ghc/issues/4039)</th>
<td>problems with semaphores in ghc-6.10.4 unix-2.3.2.0</td></tr>
<tr><th>[\#4209](https://gitlab.staging.haskell.org/ghc/ghc/issues/4209)</th>
<td>LLVM: Vector code segfaults under OSX</td></tr>
<tr><th>[\#4219](https://gitlab.staging.haskell.org/ghc/ghc/issues/4219)</th>
<td>sequence is not tail recursive, doesn't work with large inputs in strict monads</td></tr>
<tr><th>[\#4282](https://gitlab.staging.haskell.org/ghc/ghc/issues/4282)</th>
<td>Proposal: make Data.List.intersperse and intercalate less strict</td></tr>
<tr><th>[\#4312](https://gitlab.staging.haskell.org/ghc/ghc/issues/4312)</th>
<td>Proposal: Further performance improvements of Data.Set</td></tr>
<tr><th>[\#4333](https://gitlab.staging.haskell.org/ghc/ghc/issues/4333)</th>
...
<tr><th>[\#4805](https://gitlab.staging.haskell.org/ghc/ghc/issues/4805)</th>
<td>segfault in Data.HashTable, triggered by long Agda runs</td></tr>
<tr><th>[\#4808](https://gitlab.staging.haskell.org/ghc/ghc/issues/4808)</th>
<td>File descriptor reuse causes Handle to point to a different stream</td></tr>
<tr><th>[\#5007](https://gitlab.staging.haskell.org/ghc/ghc/issues/5007)</th>
<td>"deriving" seems to ignore class context for a type family</td></tr>
<tr><th>[\#5031](https://gitlab.staging.haskell.org/ghc/ghc/issues/5031)</th>
<td>GHC API (7.0.2) + runhaskell causes bus error in Mac OS X 10.6</td></tr>
<tr><th>[\#5129](https://gitlab.staging.haskell.org/ghc/ghc/issues/5129)</th>
<td>"evaluate" optimized away</td></tr>
<tr><th>[\#5162](https://gitlab.staging.haskell.org/ghc/ghc/issues/5162)</th>
<td>Add Int index functions to Data.Set</td></tr>
<tr><th>[\#5216](https://gitlab.staging.haskell.org/ghc/ghc/issues/5216)</th>
<td>Haskell Platform 2011.2.0.1 Setup</td></tr>
<tr><th>[\#5280](https://gitlab.staging.haskell.org/ghc/ghc/issues/5280)</th>
<td>System.Random commits (rand \`mod\` base) error.</td></tr>
<tr><th>[\#5465](https://gitlab.staging.haskell.org/ghc/ghc/issues/5465)</th>
<td>deepseq missing NFData instances for (-\>), Data.Fixed and Data.Version</td></tr>
<tr><th>[\#5468](https://gitlab.staging.haskell.org/ghc/ghc/issues/5468)</th>
<td>Implement deepseq-\>{array,containers} dependancy reversal proposal</td></tr>
<tr><th>[\#5497](https://gitlab.staging.haskell.org/ghc/ghc/issues/5497)</th>
<td>Relax haskell98 build-dep on time package to allow time-1.4</td></tr>
<tr><th>[\#5557](https://gitlab.staging.haskell.org/ghc/ghc/issues/5557)</th>
<td>Code using seq has wrong strictness (too lazy)</td></tr>
<tr><th>[\#5587](https://gitlab.staging.haskell.org/ghc/ghc/issues/5587)</th>
<td>Code using seq has wrong strictness (too lazy) when optimised</td></tr>
<tr><th>[\#5625](https://gitlab.staging.haskell.org/ghc/ghc/issues/5625)</th>
<td>Code using seq has wrong strictness when unoptimised (too lazy)</td></tr>
<tr><th>[\#5691](https://gitlab.staging.haskell.org/ghc/ghc/issues/5691)</th>
<td>Crash: strange interaction of ScopedTypeVariables extension with type class name resolution</td></tr>
<tr><th>[\#5723](https://gitlab.staging.haskell.org/ghc/ghc/issues/5723)</th>
<td>GHCi (7.4.0.20111219) sometimes segfaults when reading .ghci</td></tr>
<tr><th>[\#5915](https://gitlab.staging.haskell.org/ghc/ghc/issues/5915)</th>
<td>Code using seq has wrong strictness when unoptimised (too strict)</td></tr>
<tr><th>[\#6059](https://gitlab.staging.haskell.org/ghc/ghc/issues/6059)</th>
<td>FFI: segfault when jumping to code buffer (under certain conditions)</td></tr>
<tr><th>[\#6140](https://gitlab.staging.haskell.org/ghc/ghc/issues/6140)</th>
<td>segfault in OS X GHCi when dealing with infinite integers</td></tr>
<tr><th>[\#7043](https://gitlab.staging.haskell.org/ghc/ghc/issues/7043)</th>
<td>32-bit GHC ceiling of negative float SEGFAULT: 11</td></tr>
<tr><th>[\#7087](https://gitlab.staging.haskell.org/ghc/ghc/issues/7087)</th>
...
<tr><th>[\#7317](https://gitlab.staging.haskell.org/ghc/ghc/issues/7317)</th>
<td>Segmentation fault in RTS' STM code on git master</td></tr>
<tr><th>[\#7472](https://gitlab.staging.haskell.org/ghc/ghc/issues/7472)</th>
<td>Build on FreeBSD fails with ncurses</td></tr>
<tr><th>[\#7475](https://gitlab.staging.haskell.org/ghc/ghc/issues/7475)</th>
<td>Mysterious Data.Word Segmentation Fault in GHCi</td></tr>
<tr><th>[\#7509](https://gitlab.staging.haskell.org/ghc/ghc/issues/7509)</th>
<td>Changing the second prompt. :{ modules\| No setting available to change.</td></tr>
<tr><th>[\#7588](https://gitlab.staging.haskell.org/ghc/ghc/issues/7588)</th>
<td>GHC HEAD built with LLVM on Mac OS X miscompiles RTS: SIGSEGV in stg\_PAP\_apply</td></tr>
<tr><th>[\#7599](https://gitlab.staging.haskell.org/ghc/ghc/issues/7599)</th>
<td>timeout does not behave as expected</td></tr>
<tr><th>[\#7616](https://gitlab.staging.haskell.org/ghc/ghc/issues/7616)</th>
<td>ghci loading package base linking crash</td></tr>
<tr><th>[\#7629](https://gitlab.staging.haskell.org/ghc/ghc/issues/7629)</th>
<td>segmentation fault in compiled program, involves gtk, selinux</td></tr>
<tr><th>[\#7669](https://gitlab.staging.haskell.org/ghc/ghc/issues/7669)</th>
...
<tr><th>[\#7838](https://gitlab.staging.haskell.org/ghc/ghc/issues/7838)</th>
<td>ghc(i) crashes on instance declaration</td></tr>
<tr><th>[\#7956](https://gitlab.staging.haskell.org/ghc/ghc/issues/7956)</th>
<td>ghci segfaults with -vN command-line options</td></tr>
<tr><th>[\#8016](https://gitlab.staging.haskell.org/ghc/ghc/issues/8016)</th>
<td>case expression with mixed use of Num instances cause spurious overlap warning</td></tr>
<tr><th>[\#8216](https://gitlab.staging.haskell.org/ghc/ghc/issues/8216)</th>
<td>Segment fault using TH</td></tr>
<tr><th>[\#8746](https://gitlab.staging.haskell.org/ghc/ghc/issues/8746)</th>
...
<tr><th>[\#9465](https://gitlab.staging.haskell.org/ghc/ghc/issues/9465)</th>
<td>configure: sed: illegal option -- r</td></tr>
<tr><th>[\#9684](https://gitlab.staging.haskell.org/ghc/ghc/issues/9684)</th>
<td>Broken build on OS X (incompatible pthread\_setname\_np API)</td></tr>
<tr><th>[\#9818](https://gitlab.staging.haskell.org/ghc/ghc/issues/9818)</th>
<td>Add \`Natural\` number type to \`base\`</td></tr>
<tr><th>[\#9822](https://gitlab.staging.haskell.org/ghc/ghc/issues/9822)</th>
<td>Add displayException to Exception typeclass</td></tr>
<tr><th>[\#10894](https://gitlab.staging.haskell.org/ghc/ghc/issues/10894)</th>
<td>In users\_guide/profiling.xml : -prof flag not to be used with cabal/stack</td></tr>
<tr><th>[\#10910](https://gitlab.staging.haskell.org/ghc/ghc/issues/10910)</th>
<td>Data families seem not to be "surely apart" from anything</td></tr>
<tr><th>[\#10960](https://gitlab.staging.haskell.org/ghc/ghc/issues/10960)</th>
<td>Closed type families don't reduce on data family instances</td></tr>
<tr><th>[\#11083](https://gitlab.staging.haskell.org/ghc/ghc/issues/11083)</th>
<td>Documentation clarification for Data.List.isSubsequenceOf</td></tr>
<tr><th>[\#11480](https://gitlab.staging.haskell.org/ghc/ghc/issues/11480)</th>
...
<tr><th>[\#11703](https://gitlab.staging.haskell.org/ghc/ghc/issues/11703)</th>
<td>Segmentation fault/internal error: evacuate: strange closure type 15 with GHC.Generics</td></tr>
<tr><th>[\#12736](https://gitlab.staging.haskell.org/ghc/ghc/issues/12736)</th>
...
<tr><th>[\#13062](https://gitlab.staging.haskell.org/ghc/ghc/issues/13062)</th>
<td>\`opt' failed in phase \`LLVM Optimiser'. (Exit code: -11)</td></tr>
<tr><th>[\#13302](https://gitlab.staging.haskell.org/ghc/ghc/issues/13302)</th>
<td>Let in do-notation with braces does not parse</td></tr>
<tr><th>[\#13832](https://gitlab.staging.haskell.org/ghc/ghc/issues/13832)</th>
<td>No parameter-validation in Control.Concurrent.setNumCapabilities</td></tr>
<tr><th>[\#13888](https://gitlab.staging.haskell.org/ghc/ghc/issues/13888)</th>
<td>GHC 8.0.2 panics when trying a simple snippet involving Parsec</td></tr>
<tr><th>[\#13889](https://gitlab.staging.haskell.org/ghc/ghc/issues/13889)</th>
<td>GHC 8.0.2 panics when trying a simple snippet involving Parsec</td></tr>
<tr><th>[\#13990](https://gitlab.staging.haskell.org/ghc/ghc/issues/13990)</th>
...
<tr><th>[\#14542](https://gitlab.staging.haskell.org/ghc/ghc/issues/14542)</th>
<td>Renamer / typechecker hang (UndecidableSuperClasses)</td></tr>
<tr><th>[\#14718](https://gitlab.staging.haskell.org/ghc/ghc/issues/14718)</th>
<td>Add Boolean type families to 'base' package</td></tr>
<tr><th>[\#14767](https://gitlab.staging.haskell.org/ghc/ghc/issues/14767)</th>
<td>Move Data.Functor.Contravariant into base</td></tr>
<tr><th>[\#14837](https://gitlab.staging.haskell.org/ghc/ghc/issues/14837)</th>
<td>Semigroup and Monoid instances for ST</td></tr>
<tr><th>[\#14857](https://gitlab.staging.haskell.org/ghc/ghc/issues/14857)</th>
<td>GHC-8.4.1 release notes don't mention 'Div', 'Mod' and other type families</td></tr>
<tr><th>[\#15027](https://gitlab.staging.haskell.org/ghc/ghc/issues/15027)</th>
<td>Remove WrappedMonad from Control.Applicative</td></tr>
<tr><th>[\#15339](https://gitlab.staging.haskell.org/ghc/ghc/issues/15339)</th>
<td>Add function equality instance for finite functions to base</td></tr>
<tr><th>[\#15500](https://gitlab.staging.haskell.org/ghc/ghc/issues/15500)</th>
<td>internal error: Unable to commit 1048576 bytes of memory. Deepseq</td></tr>
<tr><th>[\#16089](https://gitlab.staging.haskell.org/ghc/ghc/issues/16089)</th>
