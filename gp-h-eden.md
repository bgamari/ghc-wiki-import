...
St Andrews will host the HackPar parallel hackathon in December to progress this...
 ...
 * [wiki:CompilerWays Compiler Ways] for parallelism
 * [wiki:StartStop Startup and Shutdown] of the parallel system
 * [wiki:Packing Packing and Unpacking Heap Structures]
 * [wiki:Primitives Primitive Operations for Coordination Control]
 * [wiki:PlaceholdersAndGC Placeholders, Garbage Collection, other Aspects]
