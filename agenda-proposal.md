...
|| || || ||
|| || || ||
|| Thu, early|| T:Jumpstart session: Build setup, Usage, Debugging || ?Vladimir? ||
|| Thu, noon || Lunch || ||
|| Thu, 1:30 || T:repository and build setup, Debugging || ?Vladimir? / Jost ||
...
|| Thu, 3pm  || Pair programming: Tracing, Packing, configure/packaging || - ||
...
|| || || ||
|| Fri, 1pm  || Lunch break || ||
|| Fri, 2pm  || Organising the development, group positioning || tba ||
...
|| Fri, late || Pair programming and brainstorm :-P ?  || - ||
|| || || ||
