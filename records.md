...
I know of three sorts of solutions:
 ...
 2. Type directed name resolution; see below and [http://hackage.haskell.org/trac/haskell-prime/wiki/TypeDirectedNameResolution]
 3. Nonextensible records with polymorphic selection & update; see below and [wiki:Records/OverloadedRecordFields]
...
5. Constructors are exactly as they are currently. I can't see any use for polymorphic constructors when records are nonextensible.
