...
While DWARF support will be much improved in 8.0.1, it is unfortunately still rather unsafe. This is due to prevalence of foreign calls in GHC/Haskell code, which can currently result in incorrect stack unwinding information ([\#11353](https://gitlab.staging.haskell.org/ghc/ghc/issues/11353), [\#11338](https://gitlab.staging.haskell.org/ghc/ghc/issues/11338), [\#11337](https://gitlab.staging.haskell.org/ghc/ghc/issues/11337)). This means that requesting a stack trace may result in a segmentation fault of the program. Unfortunately, fixing this was beyond the scope of my time budget for 8.0, although hopefully can be done for 8.2.
...
due to foreign calls; see [\#11137](https://gitlab.staging.haskell.org/ghc/ghc/issues/11137), [\#11138](https://gitlab.staging.haskell.org/ghc/ghc/issues/11138)). GHC 8.2 will hopefully fix up these remaining cases,
