...
<table><tr><th>[\#10892](https://gitlab.staging.haskell.org/ghc/ghc/issues/10892)</th>
...
<table><tr><th>[\#11607](https://gitlab.staging.haskell.org/ghc/ghc/issues/11607)</th>
<td>ApplicativeDo easily foiled with \`pure\`</td></tr>
<tr><th>[\#11612](https://gitlab.staging.haskell.org/ghc/ghc/issues/11612)</th>
<td>Bug in ApplicativeDo</td></tr>
<tr><th>[\#11835](https://gitlab.staging.haskell.org/ghc/ghc/issues/11835)</th>
<td>ApplicativeDo failed to desugar last line with pure $ \<expr\></td></tr>
<tr><th>[\#12143](https://gitlab.staging.haskell.org/ghc/ghc/issues/12143)</th>
<td>ApplicativeDo Fails to Desugar 'return True'</td></tr>
<tr><th>[\#12490](https://gitlab.staging.haskell.org/ghc/ghc/issues/12490)</th>
<td>With RebindableSyntax, ApplicativeDo should eliminate return/pure</td></tr>
<tr><th>[\#13242](https://gitlab.staging.haskell.org/ghc/ghc/issues/13242)</th>
<td>Panic "StgCmmEnv: variable not found" with ApplicativeDo and ExistentialQuantification</td></tr>
<tr><th>[\#13648](https://gitlab.staging.haskell.org/ghc/ghc/issues/13648)</th>
<td>ApplicativeDo selects "GHC.Base.Monad.return" when actions are used without patterns.</td></tr>
<tr><th>[\#13875](https://gitlab.staging.haskell.org/ghc/ghc/issues/13875)</th>
<td>ApplicativeDo desugaring is lazier than standard desugaring</td></tr>
<tr><th>[\#14105](https://gitlab.staging.haskell.org/ghc/ghc/issues/14105)</th>
<td>ApplicativeDo causes GHC panic on irrefutable list pattern match</td></tr>
<tr><th>[\#14163](https://gitlab.staging.haskell.org/ghc/ghc/issues/14163)</th>
<td>Stack Overflow with ApplicativeDo</td></tr>
<tr><th>[\#14249](https://gitlab.staging.haskell.org/ghc/ghc/issues/14249)</th>
<td>ApplicativeDo: Pattern matching on a bind forces a Monad constraint</td></tr>
<tr><th>[\#14471](https://gitlab.staging.haskell.org/ghc/ghc/issues/14471)</th>
<td>Certain do blocks cause TH to barf when ApplicativeDo is enabled</td></tr>
<tr><th>[\#14670](https://gitlab.staging.haskell.org/ghc/ghc/issues/14670)</th>
<td>-XRebindableSyntax needs return?</td></tr>
<tr><th>[\#15422](https://gitlab.staging.haskell.org/ghc/ghc/issues/15422)</th>
