...
Please note that the new representation is now '''stricter regarding internal invariants''' (note the if-and-only-ifs `iff`s in the comments above). For more details, see
 ...
 - [hackage:integer-gmp-1.0.0.0/candidate/docs/GHC-Integer-GMP-Internals.html GHC.Integer.GMP.Internals's Haddock]
...
See https://github.com/bos/aeson/commit/730a8c42b75f38e241da39933b03735a7c905538 for an example how to make code compatible with both, `time < 1.5` and `time >= 1.5`.
