...
If you have added custom fields to your tickets (a feature since v0.8, see [TracTicketsCustomFields](trac-tickets-custom-fields)), you can write a SQL query to cover them. You'll need to make a join on the ticket\_custom table, but this isn't especially easy.
