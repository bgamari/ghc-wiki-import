...
There is a ticket to track progress: [\#9476](https://gitlab.staging.haskell.org/ghc/ghc/issues/9476). There's a paper in the making at [
...
Sebastian Graf has rebased this branch in mid April 2018. After some debugging and fixups, it passed `./validate` (modulo some compiler perf tests) in [
