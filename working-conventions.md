...
First, make sure you are familiar with GHC's [wiki:Licensing].  Unless you say otherwise, we will assume that any contributions you make are supplied to us under the same license as the existing code.
...
The policy on testing patches is at: [wiki:TestingPatches].
