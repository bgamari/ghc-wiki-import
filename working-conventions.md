 ...
 * [wiki:WorkingConventions/FixingBugs How to fix a bug in GHC]. Also check out the summary of [wiki:Status/Tickets open tickets, listed by component], and the [wiki:BugSweep GHC bug sweep].
