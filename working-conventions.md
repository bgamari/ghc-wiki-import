 ...
 * [wiki:WorkingConventions/FixingBugs How to fix a bug]
 * [wiki:WorkingConventions/AddingFeatures How to add a new feature]
...
The following are GHC-specific policies for using the Trac bug tracking system. (See also [wiki:ReportABug the bug reporting guidelines].)
