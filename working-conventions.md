 ...
 * [wiki:WorkingConventions/FixingBugs How to fix a bug in GHC]. You can see all open bugs by clicking on "All bugs" in the left margin of this page.  At the top of the list is a filter you can use to refine your search. Also check out the [wiki:Status/Tickets summary of open tickets, listed by component], and the [wiki:BugSweep GHC bug sweep].
