...
There are separate guidelines for proposing changes to standard libraries; see [http://haskell.org/haskellwiki/Library_submissions Library Submissions].
...
For people with commit privileges, the policy on testing patches is at: [wiki:TestingPatches]
