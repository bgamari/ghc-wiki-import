...
This page summarizes the design of injective type families ([\#6018](https://gitlab.staging.haskell.org/ghc/ghc/issues/6018)).
...
Other tickets related to further development of injective type families: [\#10833](https://gitlab.staging.haskell.org/ghc/ghc/issues/10833), [\#11511](https://gitlab.staging.haskell.org/ghc/ghc/issues/11511).
...
full discussion of injective type families see Haskell Symposium 2015 [
paper](http://research.microsoft.com/en-us/um/people/simonpj/papers/ext-f/injective-type-families-acm.pdf)
...
<table><tr><th>[\#6018](https://gitlab.staging.haskell.org/ghc/ghc/issues/6018)</th>
...
<tr><th>[\#12430](https://gitlab.staging.haskell.org/ghc/ghc/issues/12430)</th>
...
<tr><th>[\#13651](https://gitlab.staging.haskell.org/ghc/ghc/issues/13651)</th>
...
<tr><th>[\#14369](https://gitlab.staging.haskell.org/ghc/ghc/issues/14369)</th>
...
The idea behind [\#6018](https://gitlab.staging.haskell.org/ghc/ghc/issues/6018) is to allow users to declare that a type family is
...
didn't finish it. The relevant Trac ticket is [\#10832](https://gitlab.staging.haskell.org/ghc/ghc/issues/10832). Partial implementation
is available as [
Phab:D1287](https://phabricator.haskell.org/D1287) and on the wip/T10832-generalised-injectivity
...
1. GHC has an outright bug in its handling of consistency,
  ...
  See Trac [\#10675](https://gitlab.staging.haskell.org/ghc/ghc/issues/10675).
...
[Here](https://gitlab.staging.haskell.org/ghc/ghc/issues/6018) it was suggested by Simon that we could infer
