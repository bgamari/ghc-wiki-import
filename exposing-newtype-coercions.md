...
This is a write-down of a discussion between me (nomeata) and SPJ at TLCA 2013, but my memory might have tricked me and I might have filled in some bits myself, so beware. It should enable to solve (parts of) [\#2110](https://gitlab.staging.haskell.org/ghc/ghc/issues/2110).
