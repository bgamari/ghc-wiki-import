...
The list of known problems tagged as Windows issues can be found [https://ghc.haskell.org/trac/ghc/query?status=!closed&os=Windows&desc=1&order=id on Trac]. It would be particularly great if people with commit rights could review the patches in the waitlist.
