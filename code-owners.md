 ...
 * '''x86'''
   ...
   * FreeBSD: [mailto:marlowsd@gmail.com Simon Marlow],[mailto:obraun@FreeBSD.org Oliver Braun],[mailto:vs@FreeBSD.org Volker Stolz]
   ...
   * MacOS X: [mailto:wolfgang.thaller@gmx.net Wolfgang Thaller],[mailto:chak@cse.unsw.edu.au Manuel Chakravarty]
 ...
 * '''m68k'''
   * Debian GNU/Linux/m68k packages: [mailto:kaol@debian.org Kari Pahula]
 ...
 * [mailto:chak@cse.unsw.edu.au Manuel Chakravarty] (FFI, Data Parallel Haskell, associated types & type families, Mac OS X port)
 ...
 * [mailto:igloo@earth.li Ian Lynagh] (GHC support engineer)
 * [mailto:marlowsd@gmail.com Simon Marlow] (GHC developer, x86_64 port, SMP support)
