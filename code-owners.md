 ...
 * '''x86'''
   ...
   * FreeBSD/i386: [mailto:marlowsd@gmail.com Simon Marlow], [mailto:haskell@FreeBSD.org FreeBSD Haskell Team]
 ...
 * '''Sparc'''
   * Solaris: [mailto:benl@ouroborus.net Ben Lippmeier]
   * Linux:   Position open
 ...
 * [mailto:benl@ouroboris.net Ben Lippmeier] (SPARC, native code generator, register allocation)
