...
- The original ticket on this feature: [\#5910](https://gitlab.staging.haskell.org/ghc/ghc/issues/5910). 
...
<table><tr><th>[\#5910](https://gitlab.staging.haskell.org/ghc/ghc/issues/5910)</th>
...
<table><tr><th>[\#9479](https://gitlab.staging.haskell.org/ghc/ghc/issues/9479)</th>
<td>Report required constraints when reporting the type of a hole</td></tr>
<tr><th>[\#10267](https://gitlab.staging.haskell.org/ghc/ghc/issues/10267)</th>
<td>Add support for typed holes in Template Haskell</td></tr>
<tr><th>[\#10954](https://gitlab.staging.haskell.org/ghc/ghc/issues/10954)</th>
<td>Add class/context information to typed hole relevant bindings</td></tr>
<tr><th>[\#11515](https://gitlab.staging.haskell.org/ghc/ghc/issues/11515)</th>
<td>PartialTypeSignatures suggests a redundant constraint with constraint families</td></tr>
<tr><th>[\#14884](https://gitlab.staging.haskell.org/ghc/ghc/issues/14884)</th>
<td>Type holes cause assertion failure in ghc-stage2 compiler during type checking</td></tr>
<tr><th>[\#14969](https://gitlab.staging.haskell.org/ghc/ghc/issues/14969)</th>
<td>Underconstrained typed holes are non-performant</td></tr>
<tr><th>[\#14996](https://gitlab.staging.haskell.org/ghc/ghc/issues/14996)</th>
<td>Typed holes are very slow</td></tr>
<tr><th>[\#15007](https://gitlab.staging.haskell.org/ghc/ghc/issues/15007)</th>
...
<tr><th>[\#15037](https://gitlab.staging.haskell.org/ghc/ghc/issues/15037)</th>
...
<tr><th>[\#15202](https://gitlab.staging.haskell.org/ghc/ghc/issues/15202)</th>
<td>Internal error showing typed hole in GHCi</td></tr>
<tr><th>[\#15321](https://gitlab.staging.haskell.org/ghc/ghc/issues/15321)</th>
...
<tr><th>[\#15401](https://gitlab.staging.haskell.org/ghc/ghc/issues/15401)</th>
<td>Weird GHCi bug</td></tr>
<tr><th>[\#15962](https://gitlab.staging.haskell.org/ghc/ghc/issues/15962)</th>
