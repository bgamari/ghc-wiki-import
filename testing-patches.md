...
We have a strict policy for validating patches before pushing them. First make sure you read either [wiki:WorkingConventions/FixingBugs How to fix a bug] or [wiki:WorkingConventions/AddingFeatures How to add a feature], and the page about [wiki:Building/RunningTests/Adding How to add a test].
