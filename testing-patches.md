...
We have a strict policy for validating [wiki:WorkingConventions/FixingBugs patches] before pushing them.

First, [wiki:Building/RunningTests/Adding add a new test] for your patch, and [wiki:Building/RunningTests/Running run it].
