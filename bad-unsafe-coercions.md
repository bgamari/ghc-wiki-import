...
Basically it introduces three new predicates in UnivCo rule:
  ...
  2. If types are unlifted then their ''size'' should be equal, under the size we mean word aligned size of value see (source:compiler/types/TyCon.hs), for unboxed tuples
