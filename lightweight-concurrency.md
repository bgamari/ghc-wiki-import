...
This section focuses on the concurrency part of the runtime system, and is intended to set a stage for subsequent discussions. This section also provides would-be GHC RTS hackers a summary of different parts of the concurrency system (as of GHC 7.4.1). 
