...
<table><tr><th>[\#4259](https://gitlab.staging.haskell.org/ghc/ghc/issues/4259)</th>
...
<table><tr><th>[\#2721](https://gitlab.staging.haskell.org/ghc/ghc/issues/2721)</th>
...
<tr><th>[\#5633](https://gitlab.staging.haskell.org/ghc/ghc/issues/5633)</th>
<td>TypeFamilies don't seem to play with LIberalTypeSynonyms</td></tr>
<tr><th>[\#6018](https://gitlab.staging.haskell.org/ghc/ghc/issues/6018)</th>
<td>Injective type families</td></tr>
<tr><th>[\#6035](https://gitlab.staging.haskell.org/ghc/ghc/issues/6035)</th>
<td>Kind-indexed type family failure with polymorphic kinds</td></tr>
<tr><th>[\#6044](https://gitlab.staging.haskell.org/ghc/ghc/issues/6044)</th>
<td>Regression error: Kind variables don't work inside of kind constructors in type families</td></tr>
<tr><th>[\#7005](https://gitlab.staging.haskell.org/ghc/ghc/issues/7005)</th>
<td>GHC 7.4.2 crashes with a panic when using type families and data kinds together</td></tr>
<tr><th>[\#7073](https://gitlab.staging.haskell.org/ghc/ghc/issues/7073)</th>
<td>Kind variable problem when declaring associated type family</td></tr>
<tr><th>[\#7156](https://gitlab.staging.haskell.org/ghc/ghc/issues/7156)</th>
<td>"Pattern match on GADT" error for non-GADT</td></tr>
<tr><th>[\#7176](https://gitlab.staging.haskell.org/ghc/ghc/issues/7176)</th>
<td>Failure to let kind variable remain uninstantiated when not needed</td></tr>
<tr><th>[\#7288](https://gitlab.staging.haskell.org/ghc/ghc/issues/7288)</th>
<td>type inference fails with where clause (RankNTypes, TypeFamilies)</td></tr>
<tr><th>[\#7477](https://gitlab.staging.haskell.org/ghc/ghc/issues/7477)</th>
<td>reifyInstances can't deal with polykinded type families</td></tr>
<tr><th>[\#7560](https://gitlab.staging.haskell.org/ghc/ghc/issues/7560)</th>
<td>Panic in conflictInstErr when branched type family instances conflict</td></tr>
<tr><th>[\#7585](https://gitlab.staging.haskell.org/ghc/ghc/issues/7585)</th>
...
<tr><th>[\#8913](https://gitlab.staging.haskell.org/ghc/ghc/issues/8913)</th>
...
<tr><th>[\#9747](https://gitlab.staging.haskell.org/ghc/ghc/issues/9747)</th>
...
<tr><th>[\#11282](https://gitlab.staging.haskell.org/ghc/ghc/issues/11282)</th>
<td>Error warns about non-injectivity of injective type family</td></tr>
<tr><th>[\#11348](https://gitlab.staging.haskell.org/ghc/ghc/issues/11348)</th>
...
<tr><th>[\#11375](https://gitlab.staging.haskell.org/ghc/ghc/issues/11375)</th>
<td>Type aliases twice as slow to compile as closed type families.</td></tr>
<tr><th>[\#11381](https://gitlab.staging.haskell.org/ghc/ghc/issues/11381)</th>
...
<tr><th>[\#11708](https://gitlab.staging.haskell.org/ghc/ghc/issues/11708)</th>
<td>Typechecker hangs when checking type families with -ddump-tc-trace turned on</td></tr>
<tr><th>[\#12057](https://gitlab.staging.haskell.org/ghc/ghc/issues/12057)</th>
<td>TypeFamilyDependencies on   Data.Type.Bool's \`Not\`</td></tr>
<tr><th>[\#12089](https://gitlab.staging.haskell.org/ghc/ghc/issues/12089)</th>
<td>:kind command allows unsaturated type family,</td></tr>
<tr><th>[\#12104](https://gitlab.staging.haskell.org/ghc/ghc/issues/12104)</th>
<td>Type families, \`TypeError\`, and \`-fdefer-type-errors\` cause "opt\_univ fell into a hole"</td></tr>
<tr><th>[\#12119](https://gitlab.staging.haskell.org/ghc/ghc/issues/12119)</th>
<td>Can't create injective type family equation with TypeError as the RHS</td></tr>
<tr><th>[\#12199](https://gitlab.staging.haskell.org/ghc/ghc/issues/12199)</th>
...
<tr><th>[\#12638](https://gitlab.staging.haskell.org/ghc/ghc/issues/12638)</th>
...
<tr><th>[\#13398](https://gitlab.staging.haskell.org/ghc/ghc/issues/13398)</th>
<td>Associated type family instance validity checking is too conservative</td></tr>
<tr><th>[\#13420](https://gitlab.staging.haskell.org/ghc/ghc/issues/13420)</th>
...
<tr><th>[\#13809](https://gitlab.staging.haskell.org/ghc/ghc/issues/13809)</th>
<td>TH-reified type family and data family instances have a paucity of kinds</td></tr>
<tr><th>[\#13901](https://gitlab.staging.haskell.org/ghc/ghc/issues/13901)</th>
...
<tr><th>[\#13962](https://gitlab.staging.haskell.org/ghc/ghc/issues/13962)</th>
...
<tr><th>[\#13985](https://gitlab.staging.haskell.org/ghc/ghc/issues/13985)</th>
<td>GHC 8.0 regression: ‘k’ is not in scope during type checking, but it passed the renamer</td></tr>
<tr><th>[\#14000](https://gitlab.staging.haskell.org/ghc/ghc/issues/14000)</th>
<td>Out of scope errors with type families do not mention scope</td></tr>
<tr><th>[\#14042](https://gitlab.staging.haskell.org/ghc/ghc/issues/14042)</th>
<td>Datatypes cannot use a type family in their return kind</td></tr>
<tr><th>[\#14045](https://gitlab.staging.haskell.org/ghc/ghc/issues/14045)</th>
<td>Data family instances must list all patterns of family, despite documentation's claims to the contrary</td></tr>
<tr><th>[\#14131](https://gitlab.staging.haskell.org/ghc/ghc/issues/14131)</th>
<td>Difference between newtype and newtype instance</td></tr>
<tr><th>[\#14179](https://gitlab.staging.haskell.org/ghc/ghc/issues/14179)</th>
...
<tr><th>[\#14333](https://gitlab.staging.haskell.org/ghc/ghc/issues/14333)</th>
...
<tr><th>[\#14440](https://gitlab.staging.haskell.org/ghc/ghc/issues/14440)</th>
...
<tr><th>[\#14547](https://gitlab.staging.haskell.org/ghc/ghc/issues/14547)</th>
...
<tr><th>[\#15057](https://gitlab.staging.haskell.org/ghc/ghc/issues/15057)</th>
...
<tr><th>[\#15144](https://gitlab.staging.haskell.org/ghc/ghc/issues/15144)</th>
<td>Type inference regression between GHC 8.0.2 and 8.2.2</td></tr>
<tr><th>[\#15318](https://gitlab.staging.haskell.org/ghc/ghc/issues/15318)</th>
<td>Core Lint error involving newtype family instances with wrappers</td></tr>
<tr><th>[\#15341](https://gitlab.staging.haskell.org/ghc/ghc/issues/15341)</th>
...
<tr><th>[\#15568](https://gitlab.staging.haskell.org/ghc/ghc/issues/15568)</th>
<td>Kind variables in type family aren't quantified in toposorted order</td></tr>
<tr><th>[\#15591](https://gitlab.staging.haskell.org/ghc/ghc/issues/15591)</th>
<td>Inconsistent kind variable binder visibility between associated and non-associated type families</td></tr>
<tr><th>[\#15592](https://gitlab.staging.haskell.org/ghc/ghc/issues/15592)</th>
<td>Type families without CUSKs cannot be given visible kind variable binders</td></tr>
<tr><th>[\#15691](https://gitlab.staging.haskell.org/ghc/ghc/issues/15691)</th>
<td>Marking Pred(S n) = n as injective</td></tr>
<tr><th>[\#15704](https://gitlab.staging.haskell.org/ghc/ghc/issues/15704)</th>
...
<tr><th>[\#15796](https://gitlab.staging.haskell.org/ghc/ghc/issues/15796)</th>
<td>Core Lint error with invalid newtype declaration</td></tr>
<tr><th>[\#15827](https://gitlab.staging.haskell.org/ghc/ghc/issues/15827)</th>
<td>Explicit foralls in type family equations are pretty-printed inconsistently (and strangely, at times)</td></tr>
<tr><th>[\#15828](https://gitlab.staging.haskell.org/ghc/ghc/issues/15828)</th>
...
<tr><th>[\#15986](https://gitlab.staging.haskell.org/ghc/ghc/issues/15986)</th>
<td>Poor error message source location reporting with unsaturated type family</td></tr>
<tr><th>[\#16002](https://gitlab.staging.haskell.org/ghc/ghc/issues/16002)</th>
