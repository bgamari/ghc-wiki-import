...
- `zonkPromote`: the remaining ones are there for a reason; but Simon still unhappy; see RAE/SLPJ Slack channel 31 Aug; and [\#15588](https://gitlab.staging.haskell.org/ghc/ghc/issues/15588) and [\#15589](https://gitlab.staging.haskell.org/ghc/ghc/issues/15589).  Stuff about "fully-known type variables".
- [\#15479](https://gitlab.staging.haskell.org/ghc/ghc/issues/15479): refactoring `tcHsType`
- [\#15577](https://gitlab.staging.haskell.org/ghc/ghc/issues/15577): surprising coercions
- [\#14887](https://gitlab.staging.haskell.org/ghc/ghc/issues/14887): telescopes
...
- [\#15346](https://gitlab.staging.haskell.org/ghc/ghc/issues/15346): `pushCoDataCon` is wrong somehow
- [\#15192](https://gitlab.staging.haskell.org/ghc/ghc/issues/15192): `GRefl`: still looking into perf changes
- [\#8095](https://gitlab.staging.haskell.org/ghc/ghc/issues/8095): coercion zapping
...
- (May 18).  Simon is very suspicious about `zonkPromote` and friends.  Revisit this once we get rid of `decideKindGeneralisationPlan`.  [\#15141](https://gitlab.staging.haskell.org/ghc/ghc/issues/15141) is a good starting point.
...
- (May 18): [\#15122](https://gitlab.staging.haskell.org/ghc/ghc/issues/15122)

- (May 18): [\#15142](https://gitlab.staging.haskell.org/ghc/ghc/issues/15142): `getInitialKinds` simplification
...
- Scoping only with explicit foralls (perhaps best after Proposal 83, because explicit kind-forall needs TypeInType).  Subsumes [\#14548](https://gitlab.staging.haskell.org/ghc/ghc/issues/14548).
- Fix [\#14451](https://gitlab.staging.haskell.org/ghc/ghc/issues/14451) (SCC analysis of type declarations)
...
- [
  Phab:4049](https://phabricator.haskell.org/4049) is the bump-TcLevel-in-type-sigs patch (Trac [\#14066](https://gitlab.staging.haskell.org/ghc/ghc/issues/14066)), which is based on D3848.
