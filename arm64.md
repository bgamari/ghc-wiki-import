...
Now we have to patch a bunch of files in the GHC source. Download [ghc\_android.patch](/trac/ghc/attachment/wiki/Arm64/ghc_android.patch)[](/trac/ghc/raw-attachment/wiki/Arm64/ghc_android.patch) and put it in `$PROJDIR`.
